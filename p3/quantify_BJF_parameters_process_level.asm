...
_quantify_BJF_parameters_process_level:     file format elf32-i386
...
int main(int argc, char* argv[]){
  ...
  46:	56                   	push   %esi
  47:	50                   	push   %eax
  48:	e8 2d 03 00 00       	call   37a <quantify_BJF_parameters_process_level>
  4d:	8d 65 f0             	lea    -0x10(%ebp),%esp
