...
_print_trace:     file format elf32-i386
...
int main(void){
  ...
  15:	8d 76 00             	lea    0x0(%esi),%esi
	while(1){
		time = uptime();
  18:	e8 0d 03 00 00       	call   32a <uptime>
  1d:	89 c3                	mov    %eax,%ebx
		if(time - first_time >= 500){
  1f:	29 f0                	sub    %esi,%eax
  21:	3d f3 01 00 00       	cmp    $0x1f3,%eax
  ...
  2b:	89 de                	mov    %ebx,%esi
          trace_syscalls(0);
  2d:	6a 00                	push   $0x0
  2f:	e8 fe 02 00 00       	call   332 <trace_syscalls>
          first_time = time;
          continue;
  34:	83 c4 10             	add    $0x10,%esp
  37:	eb df                	jmp    18 <main+0x18>
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
  3d:	66 90                	xchg   %ax,%ax
  3f:	90                   	nop
