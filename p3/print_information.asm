...
_print_information:     file format elf32-i386
...
int main(int argc, char* argv[]){
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	print_information();
  11:	e8 34 03 00 00       	call   34a <print_information>
	exit();
