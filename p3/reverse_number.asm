...
_reverse_number:     file format elf32-i386
...
{ 
  ...
  26:	89 c7                	mov    %eax,%edi
    ...
    asm("movl $23, %%eax;" :);
  28:	b8 17 00 00 00       	mov    $0x17,%eax
    asm("int $64");
  2d:	cd 40                	int    $0x40
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 9d 07 00 00       	mov    $0x79d,%ebx
        while(*s != 0){
