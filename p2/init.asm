...
main(void)
{
  ...
  13:	6a 02                	push   $0x2
  15:	68 18 08 00 00       	push   $0x818
  1a:	e8 93 03 00 00       	call   3b2 <open>
  1f:	83 c4 10             	add    $0x10,%esp
  22:	85 c0                	test   %eax,%eax
  24:	0f 88 ce 00 00 00    	js     f8 <main+0xf8>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  2d:	6a 00                	push   $0x0
  2f:	e8 b6 03 00 00       	call   3ea <dup>
  dup(0);  // stderr
  34:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3b:	e8 aa 03 00 00       	call   3ea <dup>
  ...
  52:	e8 69 04 00 00       	call   4c0 <printf>
    pid = fork();
  57:	e8 0e 03 00 00       	call   36a <fork>
  5c:	89 c3                	mov    %eax,%ebx
    poo = fork();
  5e:	e8 07 03 00 00       	call   36a <fork>
    if(pid < 0){
  ...
  68:	89 c6                	mov    %eax,%esi
    if(pid < 0){
  6a:	78 31                	js     9d <main+0x9d>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  6c:	74 42                	je     b0 <main+0xb0>
      exec("sh", argv);
  ...
  78:	e8 fd 02 00 00       	call   37a <wait>
  7d:	85 c0                	test   %eax,%eax
  7f:	78 c7                	js     48 <main+0x48>
  81:	39 c3                	cmp    %eax,%ebx
  83:	74 c3                	je     48 <main+0x48>
  85:	39 c6                	cmp    %eax,%esi
  87:	74 bf                	je     48 <main+0x48>
      printf(1, "zombie!\n");
  89:	83 ec 08             	sub    $0x8,%esp
  8c:	68 6b 08 00 00       	push   $0x86b
  91:	6a 01                	push   $0x1
  93:	e8 28 04 00 00       	call   4c0 <printf>
  98:	83 c4 10             	add    $0x10,%esp
  9b:	eb db                	jmp    78 <main+0x78>
      printf(1, "init: fork failed\n");
  9d:	50                   	push   %eax
  9e:	50                   	push   %eax
  9f:	68 33 08 00 00       	push   $0x833
  a4:	6a 01                	push   $0x1
  a6:	e8 15 04 00 00       	call   4c0 <printf>
      exit();
  ab:	e8 c2 02 00 00       	call   372 <exit>
      exec("sh", argv);
  b0:	53                   	push   %ebx
  b1:	53                   	push   %ebx
  b2:	68 50 0b 00 00       	push   $0xb50
  b7:	68 46 08 00 00       	push   $0x846
  bc:	e8 e9 02 00 00       	call   3aa <exec>
      printf(1, "init: exec sh failed\n");
  c1:	5e                   	pop    %esi
  c2:	58                   	pop    %eax
  c3:	68 49 08 00 00       	push   $0x849
  c8:	6a 01                	push   $0x1
  ...
  d4:	50                   	push   %eax
  d5:	50                   	push   %eax
  d6:	68 48 0b 00 00       	push   $0xb48
  db:	68 5f 08 00 00       	push   $0x85f
  e0:	e8 c5 02 00 00       	call   3aa <exec>
      printf(1, "init: exec print_trace failed\n");
  e5:	5a                   	pop    %edx
  e6:	59                   	pop    %ecx
  e7:	68 74 08 00 00       	push   $0x874
  ec:	6a 01                	push   $0x1
 ...
 118:	e9 0d ff ff ff       	jmp    2a <main+0x2a>
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb 94 08 00 00       	mov    $0x894,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 58 0b 00 00       	mov    0xb58,%eax
{
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6cf:	a3 58 0b 00 00       	mov    %eax,0xb58
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
 ...
 6e6:	72 ce                	jb     6b6 <free+0x26>
{
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 58 0b 00 00       	mov    %eax,0xb58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 58 0b 00 00    	mov    0xb58,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 47                	jae    7b8 <malloc+0x98>
    ...
    if(p == freep)
 771:	39 05 58 0b 00 00    	cmp    %eax,0xb58
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
  return freep;
 79b:	8b 15 58 0b 00 00    	mov    0xb58,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 58 0b 00 00    	mov    %edx,0xb58
}
 ...
 7d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 58 0b 00 00 5c 	movl   $0xb5c,0xb58
 7e7:	0b 00 00 
 7ea:	c7 05 5c 0b 00 00 5c 	movl   $0xb5c,0xb5c
 7f1:	0b 00 00 
    base.s.size = 0;
 7f4:	b8 5c 0b 00 00       	mov    $0xb5c,%eax
 7f9:	c7 05 60 0b 00 00 00 	movl   $0x0,0xb60
 800:	00 00 00 
