...
{ 
  ...
  11:	6a 00                	push   $0x0
  13:	e8 0a 03 00 00       	call   322 <trace_syscalls>
  printf(1,"%d\n", a);
  18:	83 c4 0c             	add    $0xc,%esp
  1b:	50                   	push   %eax
  1c:	68 28 07 00 00       	push   $0x728
  21:	6a 01                	push   $0x1
  23:	e8 a8 03 00 00       	call   3d0 <printf>
 ...
 339:	85 d2                	test   %edx,%edx
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 34 07 00 00 	movzbl 0x734(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 584:	e9 8f fe ff ff       	jmp    418 <printf+0x48>
          s = "(null)";
 589:	bb 2c 07 00 00       	mov    $0x72c,%ebx
        while(*s != 0){
 ...
 5a1:	a1 d8 09 00 00       	mov    0x9d8,%eax
{
 ...
 5dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5df:	a3 d8 09 00 00       	mov    %eax,0x9d8
}
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6d7:	89 15 d8 09 00 00    	mov    %edx,0x9d8
}
 ...
 6e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 d8 09 00 00 dc 	movl   $0x9dc,0x9d8
 6f7:	09 00 00 
 6fa:	c7 05 dc 09 00 00 dc 	movl   $0x9dc,0x9dc
 701:	09 00 00 
    base.s.size = 0;
 704:	b8 dc 09 00 00       	mov    $0x9dc,%eax
 709:	c7 05 e0 09 00 00 00 	movl   $0x0,0x9e0
 710:	00 00 00 
