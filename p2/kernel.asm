...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 b7 7d 10 80 	movl   $0x80107db7,(%esp)
...
80101ec8:	68 a2 7b 10 80       	push   $0x80107ba2
...
80102322:	81 fb a8 6b 11 80    	cmp    $0x80116ba8,%ebx
...
80102eb7:	68 a8 6b 11 80       	push   $0x80116ba8
...
8010361c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103620:	81 c3 d8 00 00 00    	add    $0xd8,%ebx
80103626:	81 fb 54 63 11 80    	cmp    $0x80116354,%ebx
...
8010364f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103655:	e8 b6 10 00 00       	call   80104710 <release>
...
80103677:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010367a:	c7 40 14 d7 5a 10 80 	movl   $0x80105ad7,0x14(%eax)
  p->context = (struct context*)sp;
...
80103689:	e8 d2 10 00 00       	call   80104760 <memset>
...
801036b2:	e8 59 10 00 00       	call   80104710 <release>
}
...
801036db:	e8 30 10 00 00       	call   80104710 <release>
...
80103730:	e8 db 0d 00 00       	call   80104510 <initlock>
}
...
801037ad:	68 28 7a 10 80       	push   $0x80107a28
...
801037e4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037e7:	e8 94 0d 00 00       	call   80104580 <pushcli>
  c = mycpu();
801037ec:	e8 4f ff ff ff       	call   80103740 <mycpu>
  p = c->proc;
801037f1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037f7:	e8 c4 0d 00 00       	call   801045c0 <popcli>
}
...
80103856:	e8 05 0f 00 00       	call   80104760 <memset>
...
801038b5:	e8 86 10 00 00       	call   80104940 <safestrcpy>
  p->cwd = namei("/");
...
80103905:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103908:	e8 73 0c 00 00       	call   80104580 <pushcli>
  c = mycpu();
8010390d:	e8 2e fe ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103912:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103918:	e8 a3 0c 00 00       	call   801045c0 <popcli>
  if(n > 0){
...
80103986:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103989:	e8 f2 0b 00 00       	call   80104580 <pushcli>
  c = mycpu();
8010398e:	e8 ad fd ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103993:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103999:	e8 22 0c 00 00       	call   801045c0 <popcli>
  if((np = allocproc()) == 0){
...
80103ace:	e8 7d 0b 00 00       	call   80104650 <acquire>
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 94 0e 00 00       	call   8010499b <swtch>
      switchkvm();
...
80103b16:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b19:	81 c3 d8 00 00 00    	add    $0xd8,%ebx
80103b1f:	81 fb 54 63 11 80    	cmp    $0x80116354,%ebx
80103b25:	72 b9                	jb     80103ae0 <scheduler+0x40>
    release(&ptable.lock);
80103b27:	83 ec 0c             	sub    $0xc,%esp
80103b2a:	68 20 2d 11 80       	push   $0x80112d20
80103b2f:	e8 dc 0b 00 00       	call   80104710 <release>
    sti();
...
80103b44:	53                   	push   %ebx
  pushcli();
80103b45:	e8 36 0a 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103b4a:	e8 f1 fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103b4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b55:	e8 66 0a 00 00       	call   801045c0 <popcli>
  if(!holding(&ptable.lock))
80103b5a:	83 ec 0c             	sub    $0xc,%esp
80103b5d:	68 20 2d 11 80       	push   $0x80112d20
80103b62:	e8 b9 0a 00 00       	call   80104620 <holding>
...
80103ba3:	e8 f3 0d 00 00       	call   8010499b <swtch>
  mycpu()->intena = intena;
...
80103c72:	e8 d9 09 00 00       	call   80104650 <acquire>
...
80103c88:	05 d8 00 00 00       	add    $0xd8,%eax
80103c8d:	3d 54 63 11 80       	cmp    $0x80116354,%eax
...
80103c9f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ca6:	05 d8 00 00 00       	add    $0xd8,%eax
80103cab:	3d 54 63 11 80       	cmp    $0x80116354,%eax
80103cb0:	72 e2                	jb     80103c94 <exit+0x94>
      p->parent = initproc;
80103cb2:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb8:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103cbd:	eb 0f                	jmp    80103cce <exit+0xce>
80103cbf:	90                   	nop
80103cc0:	81 c2 d8 00 00 00    	add    $0xd8,%edx
80103cc6:	81 fa 54 63 11 80    	cmp    $0x80116354,%edx
80103ccc:	73 3a                	jae    80103d08 <exit+0x108>
    if(p->parent == curproc){
...
80103cda:	75 e4                	jne    80103cc0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cdc:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103ce1:	eb 11                	jmp    80103cf4 <exit+0xf4>
80103ce3:	90                   	nop
80103ce4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ce8:	05 d8 00 00 00       	add    $0xd8,%eax
80103ced:	3d 54 63 11 80       	cmp    $0x80116354,%eax
80103cf2:	73 cc                	jae    80103cc0 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
...
80103d08:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
80103d0f:	e8 2c fe ff ff       	call   80103b40 <sched>
  panic("zombie exit");
80103d14:	83 ec 0c             	sub    $0xc,%esp
80103d17:	68 3d 79 10 80       	push   $0x8010793d
80103d1c:	e8 6f c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d21:	83 ec 0c             	sub    $0xc,%esp
80103d24:	68 30 79 10 80       	push   $0x80107930
...
80103d3c:	e8 0f 09 00 00       	call   80104650 <acquire>
  pushcli();
80103d41:	e8 3a 08 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103d46:	e8 f5 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d51:	e8 6a 08 00 00       	call   801045c0 <popcli>
...
80103d69:	e8 a2 09 00 00       	call   80104710 <release>
}
...
80103d8c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d8f:	e8 ec 07 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103d94:	e8 a7 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d99:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d9f:	e8 1c 08 00 00       	call   801045c0 <popcli>
  if(p == 0)
...
80103dc0:	e8 8b 08 00 00       	call   80104650 <acquire>
    release(lk);
80103dc5:	89 34 24             	mov    %esi,(%esp)
80103dc8:	e8 43 09 00 00       	call   80104710 <release>
  p->chan = chan;
...
80103dea:	e8 21 09 00 00       	call   80104710 <release>
    acquire(lk);
...
80103dfb:	5d                   	pop    %ebp
    acquire(lk);
80103dfc:	e9 4f 08 00 00       	jmp    80104650 <acquire>
...
80103e78:	81 c3 d8 00 00 00    	add    $0xd8,%ebx
80103e7e:	81 fb 54 63 11 80    	cmp    $0x80116354,%ebx
80103e84:	73 1e                	jae    80103ea4 <wait+0x64>
      if(p->parent != curproc)
80103e86:	39 73 14             	cmp    %esi,0x14(%ebx)
80103e89:	75 ed                	jne    80103e78 <wait+0x38>
      if(p->state == ZOMBIE){
80103e8b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103e8f:	74 37                	je     80103ec8 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e91:	81 c3 d8 00 00 00    	add    $0xd8,%ebx
      havekids = 1;
80103e97:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e9c:	81 fb 54 63 11 80    	cmp    $0x80116354,%ebx
80103ea2:	72 e2                	jb     80103e86 <wait+0x46>
    if(!havekids || curproc->killed){
80103ea4:	85 c0                	test   %eax,%eax
80103ea6:	74 76                	je     80103f1e <wait+0xde>
80103ea8:	8b 46 24             	mov    0x24(%esi),%eax
80103eab:	85 c0                	test   %eax,%eax
80103ead:	75 6f                	jne    80103f1e <wait+0xde>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103eaf:	83 ec 08             	sub    $0x8,%esp
80103eb2:	68 20 2d 11 80       	push   $0x80112d20
80103eb7:	56                   	push   %esi
80103eb8:	e8 c3 fe ff ff       	call   80103d80 <sleep>
    havekids = 0;
80103ebd:	83 c4 10             	add    $0x10,%esp
80103ec0:	eb a8                	jmp    80103e6a <wait+0x2a>
80103ec2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        kfree(p->kstack);
80103ec8:	83 ec 0c             	sub    $0xc,%esp
80103ecb:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
80103ece:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103ed1:	e8 3a e4 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
80103ed6:	5a                   	pop    %edx
...
80103eda:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ee1:	e8 4a 31 00 00       	call   80107030 <freevm>
        release(&ptable.lock);
80103ee6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103eed:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103ef4:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103efb:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103eff:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103f06:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f0d:	e8 fe 07 00 00       	call   80104710 <release>
        return pid;
80103f12:	83 c4 10             	add    $0x10,%esp
}
80103f15:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103f18:	89 f0                	mov    %esi,%eax
80103f1a:	5b                   	pop    %ebx
80103f1b:	5e                   	pop    %esi
80103f1c:	5d                   	pop    %ebp
80103f1d:	c3                   	ret    
...
80103f1e:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80103f21:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f26:	68 20 2d 11 80       	push   $0x80112d20
80103f2b:	e8 e0 07 00 00       	call   80104710 <release>
      return -1;
80103f30:	83 c4 10             	add    $0x10,%esp
80103f33:	eb e0                	jmp    80103f15 <wait+0xd5>
...
80103f4f:	e8 fc 06 00 00       	call   80104650 <acquire>
80103f54:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f57:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103f5c:	eb 0e                	jmp    80103f6c <wakeup+0x2c>
80103f5e:	66 90                	xchg   %ax,%ax
80103f60:	05 d8 00 00 00       	add    $0xd8,%eax
80103f65:	3d 54 63 11 80       	cmp    $0x80116354,%eax
80103f6a:	73 1e                	jae    80103f8a <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
80103f6c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103f70:	75 ee                	jne    80103f60 <wakeup+0x20>
80103f72:	3b 58 20             	cmp    0x20(%eax),%ebx
80103f75:	75 e9                	jne    80103f60 <wakeup+0x20>
      p->state = RUNNABLE;
80103f77:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f7e:	05 d8 00 00 00       	add    $0xd8,%eax
80103f83:	3d 54 63 11 80       	cmp    $0x80116354,%eax
80103f88:	72 e2                	jb     80103f6c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
80103f8a:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80103f91:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103f94:	c9                   	leave  
  release(&ptable.lock);
80103f95:	e9 76 07 00 00       	jmp    80104710 <release>
...
80103faf:	e8 9c 06 00 00       	call   80104650 <acquire>
80103fb4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fb7:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103fbc:	eb 0e                	jmp    80103fcc <kill+0x2c>
80103fbe:	66 90                	xchg   %ax,%ax
80103fc0:	05 d8 00 00 00       	add    $0xd8,%eax
80103fc5:	3d 54 63 11 80       	cmp    $0x80116354,%eax
80103fca:	73 34                	jae    80104000 <kill+0x60>
    if(p->pid == pid){
80103fcc:	39 58 10             	cmp    %ebx,0x10(%eax)
80103fcf:	75 ef                	jne    80103fc0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80103fd1:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
80103fd5:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
80103fdc:	75 07                	jne    80103fe5 <kill+0x45>
        p->state = RUNNABLE;
80103fde:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80103fe5:	83 ec 0c             	sub    $0xc,%esp
80103fe8:	68 20 2d 11 80       	push   $0x80112d20
80103fed:	e8 1e 07 00 00       	call   80104710 <release>
      return 0;
80103ff2:	83 c4 10             	add    $0x10,%esp
80103ff5:	31 c0                	xor    %eax,%eax
    }
  }
  release(&ptable.lock);
  return -1;
}
80103ff7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103ffa:	c9                   	leave  
80103ffb:	c3                   	ret    
...
80104008:	e8 03 07 00 00       	call   80104710 <release>
  return -1;
...
8010403b:	68 b7 7d 10 80       	push   $0x80107db7
80104040:	e8 1b c6 ff ff       	call   80100660 <cprintf>
80104045:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104048:	81 c3 d8 00 00 00    	add    $0xd8,%ebx
8010404e:	81 fb 54 63 11 80    	cmp    $0x80116354,%ebx
80104054:	0f 83 86 00 00 00    	jae    801040e0 <procdump+0xc0>
    if(p->state == UNUSED)
8010405a:	8b 43 0c             	mov    0xc(%ebx),%eax
8010405d:	85 c0                	test   %eax,%eax
8010405f:	74 e7                	je     80104048 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104061:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104064:	ba 60 79 10 80       	mov    $0x80107960,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104069:	77 11                	ja     8010407c <procdump+0x5c>
8010406b:	8b 14 85 ac 7a 10 80 	mov    -0x7fef8554(,%eax,4),%edx
      state = "???";
80104072:	b8 60 79 10 80       	mov    $0x80107960,%eax
80104077:	85 d2                	test   %edx,%edx
80104079:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010407c:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010407f:	50                   	push   %eax
80104080:	52                   	push   %edx
80104081:	ff 73 10             	pushl  0x10(%ebx)
80104084:	68 64 79 10 80       	push   $0x80107964
80104089:	e8 d2 c5 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
8010408e:	83 c4 10             	add    $0x10,%esp
80104091:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80104095:	75 a1                	jne    80104038 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104097:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010409a:	83 ec 08             	sub    $0x8,%esp
8010409d:	8d 7d c0             	lea    -0x40(%ebp),%edi
801040a0:	50                   	push   %eax
801040a1:	8b 43 1c             	mov    0x1c(%ebx),%eax
801040a4:	8b 40 0c             	mov    0xc(%eax),%eax
801040a7:	83 c0 08             	add    $0x8,%eax
801040aa:	50                   	push   %eax
801040ab:	e8 80 04 00 00       	call   80104530 <getcallerpcs>
...
801040c5:	83 c7 04             	add    $0x4,%edi
801040c8:	52                   	push   %edx
801040c9:	68 a1 73 10 80       	push   $0x801073a1
801040ce:	e8 8d c5 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801040d3:	83 c4 10             	add    $0x10,%esp
801040d6:	39 fe                	cmp    %edi,%esi
801040d8:	75 de                	jne    801040b8 <procdump+0x98>
801040da:	e9 59 ff ff ff       	jmp    80104038 <procdump+0x18>
801040df:	90                   	nop
  }
}
801040e0:	8d 65 f4             	lea    -0xc(%ebp),%esp
801040e3:	5b                   	pop    %ebx
801040e4:	5e                   	pop    %esi
801040e5:	5f                   	pop    %edi
801040e6:	5d                   	pop    %ebp
...
801040f3:	8b 45 08             	mov    0x8(%ebp),%eax
  switch(num){
801040f6:	83 f8 16             	cmp    $0x16,%eax
801040f9:	0f 87 71 01 00 00    	ja     80104270 <print_name+0x180>
801040ff:	ff 24 85 50 7a 10 80 	jmp    *-0x7fef85b0(,%eax,4)
...
80104110:	c7 45 08 e2 79 10 80 	movl   $0x801079e2,0x8(%ebp)
      break;
  }
...
80104117:	5d                   	pop    %ebp
      cprintf("Trace_syscalls");
80104118:	e9 43 c5 ff ff       	jmp    80100660 <cprintf>
8010411d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Close");
80104120:	c7 45 08 dc 79 10 80 	movl   $0x801079dc,0x8(%ebp)
}
80104127:	5d                   	pop    %ebp
      cprintf("Close");
80104128:	e9 33 c5 ff ff       	jmp    80100660 <cprintf>
8010412d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Mkdir");
80104130:	c7 45 08 d6 79 10 80 	movl   $0x801079d6,0x8(%ebp)
}
80104137:	5d                   	pop    %ebp
      cprintf("Mkdir");
80104138:	e9 23 c5 ff ff       	jmp    80100660 <cprintf>
8010413d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Link");
80104140:	c7 45 08 d1 79 10 80 	movl   $0x801079d1,0x8(%ebp)
}
80104147:	5d                   	pop    %ebp
      cprintf("Link");
80104148:	e9 13 c5 ff ff       	jmp    80100660 <cprintf>
8010414d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Unlink");
80104150:	c7 45 08 ca 79 10 80 	movl   $0x801079ca,0x8(%ebp)
}
80104157:	5d                   	pop    %ebp
      cprintf("Unlink");
80104158:	e9 03 c5 ff ff       	jmp    80100660 <cprintf>
8010415d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Mknod");
80104160:	c7 45 08 c4 79 10 80 	movl   $0x801079c4,0x8(%ebp)
}
80104167:	5d                   	pop    %ebp
      cprintf("Mknod");
80104168:	e9 f3 c4 ff ff       	jmp    80100660 <cprintf>
8010416d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Write");
80104170:	c7 45 08 be 79 10 80 	movl   $0x801079be,0x8(%ebp)
}
80104177:	5d                   	pop    %ebp
      cprintf("Write");
80104178:	e9 e3 c4 ff ff       	jmp    80100660 <cprintf>
8010417d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Open");
80104180:	c7 45 08 b9 79 10 80 	movl   $0x801079b9,0x8(%ebp)
}
80104187:	5d                   	pop    %ebp
      cprintf("Open");
80104188:	e9 d3 c4 ff ff       	jmp    80100660 <cprintf>
8010418d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Uptime");
80104190:	c7 45 08 b2 79 10 80 	movl   $0x801079b2,0x8(%ebp)
}
80104197:	5d                   	pop    %ebp
      cprintf("Uptime");
80104198:	e9 c3 c4 ff ff       	jmp    80100660 <cprintf>
8010419d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Sleep");
801041a0:	c7 45 08 ac 79 10 80 	movl   $0x801079ac,0x8(%ebp)
}
801041a7:	5d                   	pop    %ebp
      cprintf("Sleep");
801041a8:	e9 b3 c4 ff ff       	jmp    80100660 <cprintf>
801041ad:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Sbrk");
801041b0:	c7 45 08 a7 79 10 80 	movl   $0x801079a7,0x8(%ebp)
}
801041b7:	5d                   	pop    %ebp
      cprintf("Sbrk");
801041b8:	e9 a3 c4 ff ff       	jmp    80100660 <cprintf>
801041bd:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Getpid");
801041c0:	c7 45 08 a0 79 10 80 	movl   $0x801079a0,0x8(%ebp)
}
801041c7:	5d                   	pop    %ebp
      cprintf("Getpid");
801041c8:	e9 93 c4 ff ff       	jmp    80100660 <cprintf>
801041cd:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Dup");
801041d0:	c7 45 08 9c 79 10 80 	movl   $0x8010799c,0x8(%ebp)
}
801041d7:	5d                   	pop    %ebp
      cprintf("Dup");
801041d8:	e9 83 c4 ff ff       	jmp    80100660 <cprintf>
801041dd:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Chdir");
801041e0:	c7 45 08 96 79 10 80 	movl   $0x80107996,0x8(%ebp)
}
801041e7:	5d                   	pop    %ebp
      cprintf("Chdir");
801041e8:	e9 73 c4 ff ff       	jmp    80100660 <cprintf>
801041ed:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Fstat");
801041f0:	c7 45 08 90 79 10 80 	movl   $0x80107990,0x8(%ebp)
}
801041f7:	5d                   	pop    %ebp
      cprintf("Fstat");
801041f8:	e9 63 c4 ff ff       	jmp    80100660 <cprintf>
801041fd:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Exec");
80104200:	c7 45 08 8b 79 10 80 	movl   $0x8010798b,0x8(%ebp)
}
80104207:	5d                   	pop    %ebp
      cprintf("Exec");
80104208:	e9 53 c4 ff ff       	jmp    80100660 <cprintf>
8010420d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Kill");
80104210:	c7 45 08 86 79 10 80 	movl   $0x80107986,0x8(%ebp)
}
80104217:	5d                   	pop    %ebp
      cprintf("Kill");
80104218:	e9 43 c4 ff ff       	jmp    80100660 <cprintf>
8010421d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Read");
80104220:	c7 45 08 81 79 10 80 	movl   $0x80107981,0x8(%ebp)
}
80104227:	5d                   	pop    %ebp
      cprintf("Read");
80104228:	e9 33 c4 ff ff       	jmp    80100660 <cprintf>
8010422d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Pipe");
80104230:	c7 45 08 7c 79 10 80 	movl   $0x8010797c,0x8(%ebp)
}
80104237:	5d                   	pop    %ebp
      cprintf("Pipe");
80104238:	e9 23 c4 ff ff       	jmp    80100660 <cprintf>
8010423d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Wait");
80104240:	c7 45 08 77 79 10 80 	movl   $0x80107977,0x8(%ebp)
}
80104247:	5d                   	pop    %ebp
      cprintf("Wait");
80104248:	e9 13 c4 ff ff       	jmp    80100660 <cprintf>
8010424d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Exit");
80104250:	c7 45 08 72 79 10 80 	movl   $0x80107972,0x8(%ebp)
}
80104257:	5d                   	pop    %ebp
      cprintf("Exit");
80104258:	e9 03 c4 ff ff       	jmp    80100660 <cprintf>
8010425d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("Fork");
80104260:	c7 45 08 6d 79 10 80 	movl   $0x8010796d,0x8(%ebp)
}
80104267:	5d                   	pop    %ebp
      cprintf("Fork");
80104268:	e9 f3 c3 ff ff       	jmp    80100660 <cprintf>
...
80104283:	53                   	push   %ebx
  struct proc *p;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104284:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
void allone(void){
80104289:	83 ec 04             	sub    $0x4,%esp
8010428c:	eb 1a                	jmp    801042a8 <allone+0x28>
8010428e:	66 90                	xchg   %ax,%ax

    if(strlen(p->name) == 0)
      break;
    p->print_state = 1;
80104290:	c7 83 d4 00 00 00 01 	movl   $0x1,0xd4(%ebx)
80104297:	00 00 00 
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010429a:	81 c3 d8 00 00 00    	add    $0xd8,%ebx
801042a0:	81 fb 54 63 11 80    	cmp    $0x80116354,%ebx
801042a6:	73 13                	jae    801042bb <allone+0x3b>
    if(strlen(p->name) == 0)
801042a8:	8d 43 6c             	lea    0x6c(%ebx),%eax
801042ab:	83 ec 0c             	sub    $0xc,%esp
801042ae:	50                   	push   %eax
801042af:	e8 cc 06 00 00       	call   80104980 <strlen>
801042b4:	83 c4 10             	add    $0x10,%esp
801042b7:	85 c0                	test   %eax,%eax
801042b9:	75 d5                	jne    80104290 <allone+0x10>
    
  }
  

}
801042bb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801042be:	c9                   	leave  
801042bf:	c3                   	ret    
...
801042d7:	e8 a4 06 00 00       	call   80104980 <strlen>
801042dc:	83 c4 10             	add    $0x10,%esp
801042df:	85 c0                	test   %eax,%eax
801042e1:	74 38                	je     8010431b <all_zero+0x5b>
801042e3:	8d 43 7c             	lea    0x7c(%ebx),%eax
801042e6:	8d 93 d4 00 00 00    	lea    0xd4(%ebx),%edx
      break;
    p->print_state = 0;
801042ec:	c7 83 d4 00 00 00 00 	movl   $0x0,0xd4(%ebx)
801042f3:	00 00 00 
...
80104306:	83 c0 04             	add    $0x4,%eax
    for (i =0; i < SYSNUM; i++){
80104309:	39 d0                	cmp    %edx,%eax
8010430b:	75 f3                	jne    80104300 <all_zero+0x40>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010430d:	81 c3 d8 00 00 00    	add    $0xd8,%ebx
80104313:	81 fb 54 63 11 80    	cmp    $0x80116354,%ebx
80104319:	72 b5                	jb     801042d0 <all_zero+0x10>
    }
  }
...
80104328:	83 f8 01             	cmp    $0x1,%eax
8010432b:	74 2a                	je     80104357 <trace_syscalls+0x37>
8010432d:	83 f8 02             	cmp    $0x2,%eax
80104330:	74 16                	je     80104348 <trace_syscalls+0x28>
      }
...
80104334:	0f 85 99 00 00 00    	jne    801043d3 <trace_syscalls+0xb3>
    all_zero();
8010433a:	e8 81 ff ff ff       	call   801042c0 <all_zero>
    return 0;
...
80104341:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104344:	5b                   	pop    %ebx
80104345:	5e                   	pop    %esi
80104346:	5d                   	pop    %ebp
80104347:	c3                   	ret    
  if( state == 1 || (state == 2 && ptable.proc -> print_state)){
80104348:	8b 0d 28 2e 11 80    	mov    0x80112e28,%ecx
  return -1;
8010434e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  if( state == 1 || (state == 2 && ptable.proc -> print_state)){
80104353:	85 c9                	test   %ecx,%ecx
80104355:	74 ea                	je     80104341 <trace_syscalls+0x21>
80104357:	be 54 2d 11 80       	mov    $0x80112d54,%esi
8010435c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104360:	8d 5e 6c             	lea    0x6c(%esi),%ebx
      if(strlen(p->name) == 0)
80104363:	83 ec 0c             	sub    $0xc,%esp
80104366:	53                   	push   %ebx
80104367:	e8 14 06 00 00       	call   80104980 <strlen>
8010436c:	83 c4 10             	add    $0x10,%esp
8010436f:	85 c0                	test   %eax,%eax
80104371:	74 cc                	je     8010433f <trace_syscalls+0x1f>
      cprintf("%s:\n",p->name);
80104373:	83 ec 08             	sub    $0x8,%esp
      p->print_state = 1;
80104376:	c7 86 d4 00 00 00 01 	movl   $0x1,0xd4(%esi)
8010437d:	00 00 00 
      cprintf("%s:\n",p->name);
80104380:	53                   	push   %ebx
80104381:	68 f1 79 10 80       	push   $0x801079f1
      for (i =0; i < SYSNUM; i++){
80104386:	31 db                	xor    %ebx,%ebx
      cprintf("%s:\n",p->name);
...
80104390:	83 ec 0c             	sub    $0xc,%esp
        print_name(i + 1);
80104393:	83 c3 01             	add    $0x1,%ebx
        cprintf("   ");
80104396:	68 1b 7a 10 80       	push   $0x80107a1b
8010439b:	e8 c0 c2 ff ff       	call   80100660 <cprintf>
        print_name(i + 1);
801043a0:	89 1c 24             	mov    %ebx,(%esp)
801043a3:	e8 48 fd ff ff       	call   801040f0 <print_name>
        cprintf(": %d\n", p->call_nums[i]);
801043a8:	58                   	pop    %eax
801043a9:	5a                   	pop    %edx
801043aa:	ff 74 9e 78          	pushl  0x78(%esi,%ebx,4)
801043ae:	68 f6 79 10 80       	push   $0x801079f6
801043b3:	e8 a8 c2 ff ff       	call   80100660 <cprintf>
      for (i =0; i < SYSNUM; i++){
801043b8:	83 c4 10             	add    $0x10,%esp
801043bb:	83 fb 16             	cmp    $0x16,%ebx
801043be:	75 d0                	jne    80104390 <trace_syscalls+0x70>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043c0:	81 c6 d8 00 00 00    	add    $0xd8,%esi
801043c6:	81 fe 54 63 11 80    	cmp    $0x80116354,%esi
801043cc:	72 92                	jb     80104360 <trace_syscalls+0x40>
801043ce:	e9 6c ff ff ff       	jmp    8010433f <trace_syscalls+0x1f>
  return -1;
801043d3:	83 c8 ff             	or     $0xffffffff,%eax
801043d6:	e9 66 ff ff ff       	jmp    80104341 <trace_syscalls+0x21>
...
801043ea:	68 c4 7a 10 80       	push   $0x80107ac4
...
80104445:	e8 36 f9 ff ff       	call   80103d80 <sleep>
  while (lk->locked) {
...
80104453:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104459:	e8 82 f3 ff ff       	call   801037e0 <myproc>
...
801044a4:	e8 97 fa ff ff       	call   80103f40 <wakeup>
  release(&lk->lk);
...
801044e3:	e8 f8 f2 ff ff       	call   801037e0 <myproc>
...
80104589:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010458a:	e8 b1 f1 ff ff       	call   80103740 <mycpu>
...
8010459f:	e8 9c f1 ff ff       	call   80103740 <mycpu>
801045a4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801045aa:	e8 91 f1 ff ff       	call   80103740 <mycpu>
...
801045ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801045f0:	e8 4b f1 ff ff       	call   80103740 <mycpu>
...
80104605:	68 cf 7a 10 80       	push   $0x80107acf
8010460a:	e8 81 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010460f:	83 ec 0c             	sub    $0xc,%esp
80104612:	68 e6 7a 10 80       	push   $0x80107ae6
...
80104638:	e8 03 f1 ff ff       	call   80103740 <mycpu>
...
80104694:	e8 a7 f0 ff ff       	call   80103740 <mycpu>
...
801046f7:	68 ed 7a 10 80       	push   $0x80107aed
...
8010474c:	68 f5 7a 10 80       	push   $0x80107af5
...
801049b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801049ba:	e8 21 ee ff ff       	call   801037e0 <myproc>
...
801049f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049fa:	e8 e1 ed ff ff       	call   801037e0 <myproc>
...
80104a65:	e8 76 ed ff ff       	call   801037e0 <myproc>
...
80104a73:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a76:	e8 65 ed ff ff       	call   801037e0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104b54:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b57:	e8 84 ec ff ff       	call   801037e0 <myproc>
...
80104b67:	83 fa 15             	cmp    $0x15,%edx
80104b6a:	77 1c                	ja     80104b88 <syscall+0x38>
80104b6c:	8b 14 85 20 7b 10 80 	mov    -0x7fef84e0(,%eax,4),%edx
...
80104b90:	68 fd 7a 10 80       	push   $0x80107afd
...
80104ce4:	68 98 7b 10 80       	push   $0x80107b98
...
80104cfc:	68 97 7b 10 80       	push   $0x80107b97
...
80104d15:	68 8b 7b 10 80       	push   $0x80107b8b
...
80104d2a:	68 9a 7b 10 80       	push   $0x80107b9a
80104d2f:	e8 5c b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104d34:	83 ec 0c             	sub    $0xc,%esp
80104d37:	68 7c 7b 10 80       	push   $0x80107b7c
...
80104d74:	e8 67 ea ff ff       	call   801037e0 <myproc>
...
80104da5:	83 ec 10             	sub    $0x10,%esp
  myproc()->call_nums[9] ++;
80104da8:	e8 33 ea ff ff       	call   801037e0 <myproc>
80104dad:	83 80 a0 00 00 00 01 	addl   $0x1,0xa0(%eax)
  if(argfd(0, 0, &f) < 0)
80104db4:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104db7:	31 c0                	xor    %eax,%eax
80104db9:	e8 92 ff ff ff       	call   80104d50 <argfd.constprop.0>
80104dbe:	85 c0                	test   %eax,%eax
80104dc0:	78 3e                	js     80104e00 <sys_dup+0x60>
  if((fd=fdalloc(f)) < 0)
80104dc2:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104dc5:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104dc7:	e8 14 ea ff ff       	call   801037e0 <myproc>
80104dcc:	eb 0a                	jmp    80104dd8 <sys_dup+0x38>
80104dce:	66 90                	xchg   %ax,%ax
  for(fd = 0; fd < NOFILE; fd++){
80104dd0:	83 c3 01             	add    $0x1,%ebx
80104dd3:	83 fb 10             	cmp    $0x10,%ebx
80104dd6:	74 28                	je     80104e00 <sys_dup+0x60>
    if(curproc->ofile[fd] == 0){
80104dd8:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80104ddc:	85 d2                	test   %edx,%edx
80104dde:	75 f0                	jne    80104dd0 <sys_dup+0x30>
      curproc->ofile[fd] = f;
80104de0:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80104de4:	83 ec 0c             	sub    $0xc,%esp
80104de7:	ff 75 f4             	pushl  -0xc(%ebp)
80104dea:	e8 01 c0 ff ff       	call   80100df0 <filedup>
  return fd;
...
80104e13:	83 ec 18             	sub    $0x18,%esp
  myproc()->call_nums[4] ++;
80104e16:	e8 c5 e9 ff ff       	call   801037e0 <myproc>
80104e1b:	83 80 8c 00 00 00 01 	addl   $0x1,0x8c(%eax)
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104e22:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104e25:	31 c0                	xor    %eax,%eax
80104e27:	e8 24 ff ff ff       	call   80104d50 <argfd.constprop.0>
80104e2c:	85 c0                	test   %eax,%eax
80104e2e:	78 48                	js     80104e78 <sys_read+0x68>
80104e30:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104e33:	83 ec 08             	sub    $0x8,%esp
80104e36:	50                   	push   %eax
80104e37:	6a 02                	push   $0x2
80104e39:	e8 22 fc ff ff       	call   80104a60 <argint>
80104e3e:	83 c4 10             	add    $0x10,%esp
80104e41:	85 c0                	test   %eax,%eax
80104e43:	78 33                	js     80104e78 <sys_read+0x68>
80104e45:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104e48:	83 ec 04             	sub    $0x4,%esp
80104e4b:	ff 75 f0             	pushl  -0x10(%ebp)
80104e4e:	50                   	push   %eax
80104e4f:	6a 01                	push   $0x1
80104e51:	e8 5a fc ff ff       	call   80104ab0 <argptr>
80104e56:	83 c4 10             	add    $0x10,%esp
80104e59:	85 c0                	test   %eax,%eax
80104e5b:	78 1b                	js     80104e78 <sys_read+0x68>
  return fileread(f, p, n);
80104e5d:	83 ec 04             	sub    $0x4,%esp
80104e60:	ff 75 f0             	pushl  -0x10(%ebp)
80104e63:	ff 75 f4             	pushl  -0xc(%ebp)
80104e66:	ff 75 ec             	pushl  -0x14(%ebp)
80104e69:	e8 f2 c0 ff ff       	call   80100f60 <fileread>
...
80104e83:	83 ec 18             	sub    $0x18,%esp
  myproc()->call_nums[15] ++;
80104e86:	e8 55 e9 ff ff       	call   801037e0 <myproc>
80104e8b:	83 80 b8 00 00 00 01 	addl   $0x1,0xb8(%eax)
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104e92:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104e95:	31 c0                	xor    %eax,%eax
80104e97:	e8 b4 fe ff ff       	call   80104d50 <argfd.constprop.0>
80104e9c:	85 c0                	test   %eax,%eax
80104e9e:	78 48                	js     80104ee8 <sys_write+0x68>
80104ea0:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104ea3:	83 ec 08             	sub    $0x8,%esp
80104ea6:	50                   	push   %eax
80104ea7:	6a 02                	push   $0x2
80104ea9:	e8 b2 fb ff ff       	call   80104a60 <argint>
80104eae:	83 c4 10             	add    $0x10,%esp
80104eb1:	85 c0                	test   %eax,%eax
80104eb3:	78 33                	js     80104ee8 <sys_write+0x68>
80104eb5:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104eb8:	83 ec 04             	sub    $0x4,%esp
80104ebb:	ff 75 f0             	pushl  -0x10(%ebp)
80104ebe:	50                   	push   %eax
80104ebf:	6a 01                	push   $0x1
80104ec1:	e8 ea fb ff ff       	call   80104ab0 <argptr>
80104ec6:	83 c4 10             	add    $0x10,%esp
80104ec9:	85 c0                	test   %eax,%eax
80104ecb:	78 1b                	js     80104ee8 <sys_write+0x68>
  return filewrite(f, p, n);
80104ecd:	83 ec 04             	sub    $0x4,%esp
80104ed0:	ff 75 f0             	pushl  -0x10(%ebp)
80104ed3:	ff 75 f4             	pushl  -0xc(%ebp)
80104ed6:	ff 75 ec             	pushl  -0x14(%ebp)
80104ed9:	e8 12 c1 ff ff       	call   80100ff0 <filewrite>
...
80104ef3:	83 ec 18             	sub    $0x18,%esp
  myproc()->call_nums[20] ++;
80104ef6:	e8 e5 e8 ff ff       	call   801037e0 <myproc>
80104efb:	83 80 cc 00 00 00 01 	addl   $0x1,0xcc(%eax)
  if(argfd(0, &fd, &f) < 0)
80104f02:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104f05:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104f08:	e8 43 fe ff ff       	call   80104d50 <argfd.constprop.0>
80104f0d:	85 c0                	test   %eax,%eax
80104f0f:	78 27                	js     80104f38 <sys_close+0x48>
  myproc()->ofile[fd] = 0;
80104f11:	e8 ca e8 ff ff       	call   801037e0 <myproc>
80104f16:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104f19:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104f1c:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104f23:	00 
  fileclose(f);
80104f24:	ff 75 f4             	pushl  -0xc(%ebp)
80104f27:	e8 14 bf ff ff       	call   80100e40 <fileclose>
  return 0;
...
80104f43:	83 ec 18             	sub    $0x18,%esp
  myproc()->call_nums[7] ++;
80104f46:	e8 95 e8 ff ff       	call   801037e0 <myproc>
80104f4b:	83 80 98 00 00 00 01 	addl   $0x1,0x98(%eax)
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80104f52:	8d 55 f0             	lea    -0x10(%ebp),%edx
80104f55:	31 c0                	xor    %eax,%eax
80104f57:	e8 f4 fd ff ff       	call   80104d50 <argfd.constprop.0>
80104f5c:	85 c0                	test   %eax,%eax
80104f5e:	78 30                	js     80104f90 <sys_fstat+0x50>
80104f60:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104f63:	83 ec 04             	sub    $0x4,%esp
80104f66:	6a 14                	push   $0x14
80104f68:	50                   	push   %eax
80104f69:	6a 01                	push   $0x1
80104f6b:	e8 40 fb ff ff       	call   80104ab0 <argptr>
80104f70:	83 c4 10             	add    $0x10,%esp
80104f73:	85 c0                	test   %eax,%eax
80104f75:	78 19                	js     80104f90 <sys_fstat+0x50>
  return filestat(f, st);
80104f77:	83 ec 08             	sub    $0x8,%esp
80104f7a:	ff 75 f4             	pushl  -0xc(%ebp)
80104f7d:	ff 75 f0             	pushl  -0x10(%ebp)
80104f80:	e8 8b bf ff ff       	call   80100f10 <filestat>
...
80104fa6:	83 ec 2c             	sub    $0x2c,%esp
  myproc()->call_nums[18] ++;
80104fa9:	e8 32 e8 ff ff       	call   801037e0 <myproc>
80104fae:	83 80 c4 00 00 00 01 	addl   $0x1,0xc4(%eax)
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104fb5:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80104fb8:	83 ec 08             	sub    $0x8,%esp
80104fbb:	50                   	push   %eax
80104fbc:	6a 00                	push   $0x0
80104fbe:	e8 4d fb ff ff       	call   80104b10 <argstr>
80104fc3:	83 c4 10             	add    $0x10,%esp
80104fc6:	85 c0                	test   %eax,%eax
80104fc8:	0f 88 fc 00 00 00    	js     801050ca <sys_link+0x12a>
80104fce:	8d 45 d0             	lea    -0x30(%ebp),%eax
80104fd1:	83 ec 08             	sub    $0x8,%esp
80104fd4:	50                   	push   %eax
80104fd5:	6a 01                	push   $0x1
80104fd7:	e8 34 fb ff ff       	call   80104b10 <argstr>
80104fdc:	83 c4 10             	add    $0x10,%esp
80104fdf:	85 c0                	test   %eax,%eax
80104fe1:	0f 88 e3 00 00 00    	js     801050ca <sys_link+0x12a>
  begin_op();
80104fe7:	e8 b4 db ff ff       	call   80102ba0 <begin_op>
  if((ip = namei(old)) == 0){
80104fec:	83 ec 0c             	sub    $0xc,%esp
80104fef:	ff 75 d4             	pushl  -0x2c(%ebp)
80104ff2:	e8 e9 ce ff ff       	call   80101ee0 <namei>
80104ff7:	83 c4 10             	add    $0x10,%esp
80104ffa:	85 c0                	test   %eax,%eax
80104ffc:	89 c3                	mov    %eax,%ebx
80104ffe:	0f 84 eb 00 00 00    	je     801050ef <sys_link+0x14f>
  ilock(ip);
...
80105015:	0f 84 bc 00 00 00    	je     801050d7 <sys_link+0x137>
  ip->nlink++;
8010501b:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  iupdate(ip);
80105020:	83 ec 0c             	sub    $0xc,%esp
  if((dp = nameiparent(new, name)) == 0)
80105023:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80105026:	53                   	push   %ebx
80105027:	e8 a4 c5 ff ff       	call   801015d0 <iupdate>
  iunlock(ip);
8010502c:	89 1c 24             	mov    %ebx,(%esp)
8010502f:	e8 2c c7 ff ff       	call   80101760 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105034:	58                   	pop    %eax
80105035:	5a                   	pop    %edx
80105036:	57                   	push   %edi
80105037:	ff 75 d0             	pushl  -0x30(%ebp)
...
80105046:	74 5c                	je     801050a4 <sys_link+0x104>
  ilock(dp);
80105048:	83 ec 0c             	sub    $0xc,%esp
8010504b:	50                   	push   %eax
8010504c:	e8 2f c6 ff ff       	call   80101680 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105051:	83 c4 10             	add    $0x10,%esp
80105054:	8b 03                	mov    (%ebx),%eax
80105056:	39 06                	cmp    %eax,(%esi)
80105058:	75 3e                	jne    80105098 <sys_link+0xf8>
8010505a:	83 ec 04             	sub    $0x4,%esp
8010505d:	ff 73 04             	pushl  0x4(%ebx)
80105060:	57                   	push   %edi
80105061:	56                   	push   %esi
80105062:	e8 b9 cd ff ff       	call   80101e20 <dirlink>
80105067:	83 c4 10             	add    $0x10,%esp
8010506a:	85 c0                	test   %eax,%eax
8010506c:	78 2a                	js     80105098 <sys_link+0xf8>
  iunlockput(dp);
...
8010507a:	e8 31 c7 ff ff       	call   801017b0 <iput>
  end_op();
8010507f:	e8 8c db ff ff       	call   80102c10 <end_op>
  return 0;
...
80105106:	83 ec 3c             	sub    $0x3c,%esp
  myproc()->call_nums[17] ++;
80105109:	e8 d2 e6 ff ff       	call   801037e0 <myproc>
8010510e:	83 80 c0 00 00 00 01 	addl   $0x1,0xc0(%eax)
  if(argstr(0, &path) < 0)
80105115:	8d 45 c0             	lea    -0x40(%ebp),%eax
80105118:	83 ec 08             	sub    $0x8,%esp
8010511b:	50                   	push   %eax
8010511c:	6a 00                	push   $0x0
8010511e:	e8 ed f9 ff ff       	call   80104b10 <argstr>
80105123:	83 c4 10             	add    $0x10,%esp
80105126:	85 c0                	test   %eax,%eax
80105128:	0f 88 78 01 00 00    	js     801052a6 <sys_unlink+0x1a6>
  if((dp = nameiparent(path, name)) == 0){
8010512e:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80105131:	e8 6a da ff ff       	call   80102ba0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105136:	83 ec 08             	sub    $0x8,%esp
80105139:	53                   	push   %ebx
8010513a:	ff 75 c0             	pushl  -0x40(%ebp)
8010513d:	e8 be cd ff ff       	call   80101f00 <nameiparent>
80105142:	83 c4 10             	add    $0x10,%esp
80105145:	85 c0                	test   %eax,%eax
80105147:	89 c6                	mov    %eax,%esi
80105149:	0f 84 61 01 00 00    	je     801052b0 <sys_unlink+0x1b0>
  ilock(dp);
...
80105158:	58                   	pop    %eax
80105159:	5a                   	pop    %edx
8010515a:	68 98 7b 10 80       	push   $0x80107b98
8010515f:	53                   	push   %ebx
80105160:	e8 2b ca ff ff       	call   80101b90 <namecmp>
80105165:	83 c4 10             	add    $0x10,%esp
80105168:	85 c0                	test   %eax,%eax
8010516a:	0f 84 04 01 00 00    	je     80105274 <sys_unlink+0x174>
80105170:	83 ec 08             	sub    $0x8,%esp
80105173:	68 97 7b 10 80       	push   $0x80107b97
80105178:	53                   	push   %ebx
80105179:	e8 12 ca ff ff       	call   80101b90 <namecmp>
8010517e:	83 c4 10             	add    $0x10,%esp
80105181:	85 c0                	test   %eax,%eax
80105183:	0f 84 eb 00 00 00    	je     80105274 <sys_unlink+0x174>
  if((ip = dirlookup(dp, name, &off)) == 0)
80105189:	8d 45 c4             	lea    -0x3c(%ebp),%eax
8010518c:	83 ec 04             	sub    $0x4,%esp
8010518f:	50                   	push   %eax
80105190:	53                   	push   %ebx
80105191:	56                   	push   %esi
80105192:	e8 19 ca ff ff       	call   80101bb0 <dirlookup>
80105197:	83 c4 10             	add    $0x10,%esp
8010519a:	85 c0                	test   %eax,%eax
8010519c:	89 c3                	mov    %eax,%ebx
8010519e:	0f 84 d0 00 00 00    	je     80105274 <sys_unlink+0x174>
  ilock(ip);
...
801051b0:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801051b5:	0f 8e 11 01 00 00    	jle    801052cc <sys_unlink+0x1cc>
  if(ip->type == T_DIR && !isdirempty(ip)){
801051bb:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801051c0:	74 6e                	je     80105230 <sys_unlink+0x130>
  memset(&de, 0, sizeof(de));
801051c2:	8d 45 d8             	lea    -0x28(%ebp),%eax
801051c5:	83 ec 04             	sub    $0x4,%esp
801051c8:	6a 10                	push   $0x10
801051ca:	6a 00                	push   $0x0
801051cc:	50                   	push   %eax
801051cd:	e8 8e f5 ff ff       	call   80104760 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801051d2:	8d 45 d8             	lea    -0x28(%ebp),%eax
801051d5:	6a 10                	push   $0x10
801051d7:	ff 75 c4             	pushl  -0x3c(%ebp)
801051da:	50                   	push   %eax
801051db:	56                   	push   %esi
801051dc:	e8 7f c8 ff ff       	call   80101a60 <writei>
801051e1:	83 c4 20             	add    $0x20,%esp
801051e4:	83 f8 10             	cmp    $0x10,%eax
801051e7:	0f 85 ec 00 00 00    	jne    801052d9 <sys_unlink+0x1d9>
  if(ip->type == T_DIR){
801051ed:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801051f2:	0f 84 98 00 00 00    	je     80105290 <sys_unlink+0x190>
  iunlockput(dp);
801051f8:	83 ec 0c             	sub    $0xc,%esp
801051fb:	56                   	push   %esi
801051fc:	e8 0f c7 ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
80105201:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105206:	89 1c 24             	mov    %ebx,(%esp)
80105209:	e8 c2 c3 ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
8010520e:	89 1c 24             	mov    %ebx,(%esp)
80105211:	e8 fa c6 ff ff       	call   80101910 <iunlockput>
  end_op();
80105216:	e8 f5 d9 ff ff       	call   80102c10 <end_op>
  return 0;
8010521b:	83 c4 10             	add    $0x10,%esp
8010521e:	31 c0                	xor    %eax,%eax
}
...
80105234:	76 8c                	jbe    801051c2 <sys_unlink+0xc2>
...
80105246:	0f 83 76 ff ff ff    	jae    801051c2 <sys_unlink+0xc2>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010525f:	75 5e                	jne    801052bf <sys_unlink+0x1bf>
    if(de.inum != 0)
80105261:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105266:	74 d8                	je     80105240 <sys_unlink+0x140>
    iunlockput(ip);
...
8010528a:	eb 94                	jmp    80105220 <sys_unlink+0x120>
...
801052f6:	83 ec 1c             	sub    $0x1c,%esp
  myproc()->call_nums[14] ++;
801052f9:	e8 e2 e4 ff ff       	call   801037e0 <myproc>
801052fe:	83 80 b4 00 00 00 01 	addl   $0x1,0xb4(%eax)
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
8010530e:	e8 fd f7 ff ff       	call   80104b10 <argstr>
80105313:	83 c4 10             	add    $0x10,%esp
80105316:	85 c0                	test   %eax,%eax
80105318:	0f 88 1e 01 00 00    	js     8010543c <sys_open+0x14c>
8010531e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105321:	83 ec 08             	sub    $0x8,%esp
80105324:	50                   	push   %eax
80105325:	6a 01                	push   $0x1
80105327:	e8 34 f7 ff ff       	call   80104a60 <argint>
8010532c:	83 c4 10             	add    $0x10,%esp
8010532f:	85 c0                	test   %eax,%eax
80105331:	0f 88 05 01 00 00    	js     8010543c <sys_open+0x14c>
    return -1;

  begin_op();
80105337:	e8 64 d8 ff ff       	call   80102ba0 <begin_op>

  if(omode & O_CREATE){
8010533c:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105340:	0f 85 aa 00 00 00    	jne    801053f0 <sys_open+0x100>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105349:	ff 75 e0             	pushl  -0x20(%ebp)
8010534c:	e8 8f cb ff ff       	call   80101ee0 <namei>
80105351:	83 c4 10             	add    $0x10,%esp
80105354:	85 c0                	test   %eax,%eax
80105356:	89 c6                	mov    %eax,%esi
80105358:	0f 84 b3 00 00 00    	je     80105411 <sys_open+0x121>
      end_op();
      return -1;
    }
    ilock(ip);
...
80105362:	e8 19 c3 ff ff       	call   80101680 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105367:	83 c4 10             	add    $0x10,%esp
8010536a:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
8010536f:	0f 84 ab 00 00 00    	je     80105420 <sys_open+0x130>
      end_op();
      return -1;
    }
  }
...
80105375:	e8 06 ba ff ff       	call   80100d80 <filealloc>
8010537a:	85 c0                	test   %eax,%eax
8010537c:	89 c7                	mov    %eax,%edi
8010537e:	0f 84 a7 00 00 00    	je     8010542b <sys_open+0x13b>
  struct proc *curproc = myproc();
80105384:	e8 57 e4 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105389:	31 db                	xor    %ebx,%ebx
8010538b:	eb 0f                	jmp    8010539c <sys_open+0xac>
8010538d:	8d 76 00             	lea    0x0(%esi),%esi
80105390:	83 c3 01             	add    $0x1,%ebx
80105393:	83 fb 10             	cmp    $0x10,%ebx
80105396:	0f 84 ac 00 00 00    	je     80105448 <sys_open+0x158>
    if(curproc->ofile[fd] == 0){
8010539c:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
801053a0:	85 d2                	test   %edx,%edx
801053a2:	75 ec                	jne    80105390 <sys_open+0xa0>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
80105441:	eb 9a                	jmp    801053dd <sys_open+0xed>
80105443:	90                   	nop
...
80105454:	eb d5                	jmp    8010542b <sys_open+0x13b>
...
80105463:	83 ec 18             	sub    $0x18,%esp
  myproc()->call_nums[19] ++;
80105466:	e8 75 e3 ff ff       	call   801037e0 <myproc>
8010546b:	83 80 c8 00 00 00 01 	addl   $0x1,0xc8(%eax)
  char *path;
  struct inode *ip;

  begin_op();
80105472:	e8 29 d7 ff ff       	call   80102ba0 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80105477:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010547a:	83 ec 08             	sub    $0x8,%esp
8010547d:	50                   	push   %eax
8010547e:	6a 00                	push   $0x0
80105480:	e8 8b f6 ff ff       	call   80104b10 <argstr>
80105485:	83 c4 10             	add    $0x10,%esp
80105488:	85 c0                	test   %eax,%eax
8010548a:	78 34                	js     801054c0 <sys_mkdir+0x60>
...
8010549b:	e8 10 f7 ff ff       	call   80104bb0 <create>
801054a0:	83 c4 10             	add    $0x10,%esp
801054a3:	85 c0                	test   %eax,%eax
801054a5:	74 19                	je     801054c0 <sys_mkdir+0x60>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
801054db:	83 80 bc 00 00 00 01 	addl   $0x1,0xbc(%eax)
  struct inode *ip;
  char *path;
  int major, minor;

  begin_op();
801054e2:	e8 b9 d6 ff ff       	call   80102ba0 <begin_op>
  if((argstr(0, &path)) < 0 ||
801054e7:	8d 45 ec             	lea    -0x14(%ebp),%eax
801054ea:	83 ec 08             	sub    $0x8,%esp
801054ed:	50                   	push   %eax
801054ee:	6a 00                	push   $0x0
801054f0:	e8 1b f6 ff ff       	call   80104b10 <argstr>
801054f5:	83 c4 10             	add    $0x10,%esp
801054f8:	85 c0                	test   %eax,%eax
801054fa:	78 64                	js     80105560 <sys_mknod+0x90>
     argint(1, &major) < 0 ||
801054fc:	8d 45 f0             	lea    -0x10(%ebp),%eax
801054ff:	83 ec 08             	sub    $0x8,%esp
80105502:	50                   	push   %eax
80105503:	6a 01                	push   $0x1
80105505:	e8 56 f5 ff ff       	call   80104a60 <argint>
  if((argstr(0, &path)) < 0 ||
8010550a:	83 c4 10             	add    $0x10,%esp
8010550d:	85 c0                	test   %eax,%eax
8010550f:	78 4f                	js     80105560 <sys_mknod+0x90>
     argint(2, &minor) < 0 ||
80105511:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105514:	83 ec 08             	sub    $0x8,%esp
80105517:	50                   	push   %eax
80105518:	6a 02                	push   $0x2
8010551a:	e8 41 f5 ff ff       	call   80104a60 <argint>
     argint(1, &major) < 0 ||
8010551f:	83 c4 10             	add    $0x10,%esp
80105522:	85 c0                	test   %eax,%eax
80105524:	78 3a                	js     80105560 <sys_mknod+0x90>
     (ip = create(path, T_DEV, major, minor)) == 0){
80105526:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
     argint(2, &minor) < 0 ||
8010552a:	83 ec 0c             	sub    $0xc,%esp
     (ip = create(path, T_DEV, major, minor)) == 0){
8010552d:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
     argint(2, &minor) < 0 ||
80105531:	ba 03 00 00 00       	mov    $0x3,%edx
80105536:	50                   	push   %eax
80105537:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010553a:	e8 71 f6 ff ff       	call   80104bb0 <create>
8010553f:	83 c4 10             	add    $0x10,%esp
80105542:	85 c0                	test   %eax,%eax
80105544:	74 1a                	je     80105560 <sys_mknod+0x90>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
8010554a:	e8 c1 c3 ff ff       	call   80101910 <iunlockput>
  end_op();
...
8010555c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80105560:	e8 ab d6 ff ff       	call   80102c10 <end_op>
    return -1;
...
80105575:	83 ec 10             	sub    $0x10,%esp
  myproc()->call_nums[8] ++;
80105578:	e8 63 e2 ff ff       	call   801037e0 <myproc>
8010557d:	83 80 9c 00 00 00 01 	addl   $0x1,0x9c(%eax)
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80105584:	e8 57 e2 ff ff       	call   801037e0 <myproc>
80105589:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010558b:	e8 10 d6 ff ff       	call   80102ba0 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105590:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105593:	83 ec 08             	sub    $0x8,%esp
80105596:	50                   	push   %eax
80105597:	6a 00                	push   $0x0
80105599:	e8 72 f5 ff ff       	call   80104b10 <argstr>
8010559e:	83 c4 10             	add    $0x10,%esp
801055a1:	85 c0                	test   %eax,%eax
801055a3:	78 6b                	js     80105610 <sys_chdir+0xa0>
801055a5:	83 ec 0c             	sub    $0xc,%esp
801055a8:	ff 75 f4             	pushl  -0xc(%ebp)
801055ab:	e8 30 c9 ff ff       	call   80101ee0 <namei>
801055b0:	83 c4 10             	add    $0x10,%esp
801055b3:	85 c0                	test   %eax,%eax
801055b5:	89 c3                	mov    %eax,%ebx
801055b7:	74 57                	je     80105610 <sys_chdir+0xa0>
    end_op();
    return -1;
  }
  ilock(ip);
...
801055c5:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801055ca:	75 2c                	jne    801055f8 <sys_chdir+0x88>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
801055d0:	e8 8b c1 ff ff       	call   80101760 <iunlock>
  iput(curproc->cwd);
801055d5:	58                   	pop    %eax
801055d6:	ff 76 68             	pushl  0x68(%esi)
801055d9:	e8 d2 c1 ff ff       	call   801017b0 <iput>
  end_op();
801055de:	e8 2d d6 ff ff       	call   80102c10 <end_op>
  curproc->cwd = ip;
801055e3:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
801055e6:	83 c4 10             	add    $0x10,%esp
801055e9:	31 c0                	xor    %eax,%eax
}
801055eb:	8d 65 f8             	lea    -0x8(%ebp),%esp
801055ee:	5b                   	pop    %ebx
801055ef:	5e                   	pop    %esi
801055f0:	5d                   	pop    %ebp
801055f1:	c3                   	ret    
...
80105626:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
  myproc()->call_nums[6] ++;
8010562c:	e8 af e1 ff ff       	call   801037e0 <myproc>
80105631:	83 80 94 00 00 00 01 	addl   $0x1,0x94(%eax)
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80105638:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
8010563e:	83 ec 08             	sub    $0x8,%esp
80105641:	50                   	push   %eax
80105642:	6a 00                	push   $0x0
80105644:	e8 c7 f4 ff ff       	call   80104b10 <argstr>
80105649:	83 c4 10             	add    $0x10,%esp
8010564c:	85 c0                	test   %eax,%eax
8010564e:	0f 88 88 00 00 00    	js     801056dc <sys_exec+0xbc>
80105654:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
8010565a:	83 ec 08             	sub    $0x8,%esp
8010565d:	50                   	push   %eax
8010565e:	6a 01                	push   $0x1
80105660:	e8 fb f3 ff ff       	call   80104a60 <argint>
80105665:	83 c4 10             	add    $0x10,%esp
80105668:	85 c0                	test   %eax,%eax
8010566a:	78 70                	js     801056dc <sys_exec+0xbc>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
8010566c:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80105672:	83 ec 04             	sub    $0x4,%esp
  for(i=0;; i++){
80105675:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
80105677:	68 80 00 00 00       	push   $0x80
8010567c:	6a 00                	push   $0x0
8010567e:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105684:	50                   	push   %eax
80105685:	e8 d6 f0 ff ff       	call   80104760 <memset>
8010568a:	83 c4 10             	add    $0x10,%esp
8010568d:	eb 2d                	jmp    801056bc <sys_exec+0x9c>
8010568f:	90                   	nop
    if(i >= NELEM(argv))
      return -1;
...
80105698:	74 56                	je     801056f0 <sys_exec+0xd0>
      argv[i] = 0;
      break;
    }
...
801056b2:	78 28                	js     801056dc <sys_exec+0xbc>
  for(i=0;; i++){
801056b4:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
801056b7:	83 fb 20             	cmp    $0x20,%ebx
801056ba:	74 20                	je     801056dc <sys_exec+0xbc>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
...
801056d0:	e8 db f2 ff ff       	call   801049b0 <fetchint>
801056d5:	83 c4 10             	add    $0x10,%esp
801056d8:	85 c0                	test   %eax,%eax
801056da:	79 b4                	jns    80105690 <sys_exec+0x70>
      return -1;
  }
...
8010572e:	83 80 88 00 00 00 01 	addl   $0x1,0x88(%eax)
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;
...
801057ee:	e8 4d b6 ff ff       	call   80100e40 <fileclose>
    fileclose(wf);
801057f3:	58                   	pop    %eax
801057f4:	ff 75 e4             	pushl  -0x1c(%ebp)
801057f7:	e8 44 b6 ff ff       	call   80100e40 <fileclose>
    return -1;
801057fc:	83 c4 10             	add    $0x10,%esp
801057ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105804:	eb c3                	jmp    801057c9 <sys_pipe+0xa9>
...
80105813:	83 ec 08             	sub    $0x8,%esp
  myproc()->call_nums[0] ++;
80105816:	e8 c5 df ff ff       	call   801037e0 <myproc>
8010581b:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
  return fork();
}
8010581f:	c9                   	leave  
  return fork();
80105820:	e9 5b e1 ff ff       	jmp    80103980 <fork>
...
8010583b:	83 80 80 00 00 00 01 	addl   $0x1,0x80(%eax)
  exit();
80105842:	e8 b9 e3 ff ff       	call   80103c00 <exit>
...
8010585b:	83 80 84 00 00 00 01 	addl   $0x1,0x84(%eax)
  return wait();
}
80105862:	c9                   	leave  
  return wait();
80105863:	e9 d8 e5 ff ff       	jmp    80103e40 <wait>
80105868:	90                   	nop
...
8010587b:	83 80 90 00 00 00 01 	addl   $0x1,0x90(%eax)
...
8010588b:	e8 d0 f1 ff ff       	call   80104a60 <argint>
80105890:	83 c4 10             	add    $0x10,%esp
80105893:	85 c0                	test   %eax,%eax
80105895:	78 19                	js     801058b0 <sys_kill+0x40>
    return -1;
  return kill(pid);
80105897:	83 ec 0c             	sub    $0xc,%esp
8010589a:	ff 75 f4             	pushl  -0xc(%ebp)
8010589d:	e8 fe e6 ff ff       	call   80103fa0 <kill>
...
801058c3:	83 ec 08             	sub    $0x8,%esp
  ...
  myproc()->call_nums[10] ++;
801058c6:	e8 15 df ff ff       	call   801037e0 <myproc>
801058cb:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
  return myproc()->pid;
801058d2:	e8 09 df ff ff       	call   801037e0 <myproc>
801058d7:	8b 40 10             	mov    0x10(%eax),%eax
}
801058da:	c9                   	leave  
801058db:	c3                   	ret    
...
801058ec:	83 80 a8 00 00 00 01 	addl   $0x1,0xa8(%eax)
  int addr;
  int n;
...
801058fc:	e8 5f f1 ff ff       	call   80104a60 <argint>
80105901:	83 c4 10             	add    $0x10,%esp
80105904:	85 c0                	test   %eax,%eax
80105906:	78 28                	js     80105930 <sys_sbrk+0x50>
    return -1;
  addr = myproc()->sz;
...
8010590d:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105910:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105912:	ff 75 f4             	pushl  -0xc(%ebp)
80105915:	e8 e6 df ff ff       	call   80103900 <growproc>
8010591a:	83 c4 10             	add    $0x10,%esp
8010591d:	85 c0                	test   %eax,%eax
8010591f:	78 0f                	js     80105930 <sys_sbrk+0x50>
    return -1;
  return addr;
}
80105921:	89 d8                	mov    %ebx,%eax
...
80105935:	eb ea                	jmp    80105921 <sys_sbrk+0x41>
...
8010594c:	83 80 ac 00 00 00 01 	addl   $0x1,0xac(%eax)
  int n;
  uint ticks0;
...
8010595c:	e8 ff f0 ff ff       	call   80104a60 <argint>
80105961:	83 c4 10             	add    $0x10,%esp
80105964:	85 c0                	test   %eax,%eax
80105966:	0f 88 8b 00 00 00    	js     801059f7 <sys_sleep+0xb7>
    return -1;
  acquire(&tickslock);
8010596c:	83 ec 0c             	sub    $0xc,%esp
8010596f:	68 60 63 11 80       	push   $0x80116360
80105974:	e8 d7 ec ff ff       	call   80104650 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105979:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010597c:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
8010597f:	8b 1d a0 6b 11 80    	mov    0x80116ba0,%ebx
  while(ticks - ticks0 < n){
80105985:	85 d2                	test   %edx,%edx
80105987:	75 28                	jne    801059b1 <sys_sleep+0x71>
80105989:	eb 55                	jmp    801059e0 <sys_sleep+0xa0>
8010598b:	90                   	nop
...
80105993:	68 60 63 11 80       	push   $0x80116360
80105998:	68 a0 6b 11 80       	push   $0x80116ba0
8010599d:	e8 de e3 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
801059a2:	a1 a0 6b 11 80       	mov    0x80116ba0,%eax
801059a7:	83 c4 10             	add    $0x10,%esp
801059aa:	29 d8                	sub    %ebx,%eax
801059ac:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801059af:	73 2f                	jae    801059e0 <sys_sleep+0xa0>
    if(myproc()->killed){
801059b1:	e8 2a de ff ff       	call   801037e0 <myproc>
801059b6:	8b 40 24             	mov    0x24(%eax),%eax
801059b9:	85 c0                	test   %eax,%eax
801059bb:	74 d3                	je     80105990 <sys_sleep+0x50>
      release(&tickslock);
801059bd:	83 ec 0c             	sub    $0xc,%esp
801059c0:	68 60 63 11 80       	push   $0x80116360
801059c5:	e8 46 ed ff ff       	call   80104710 <release>
      return -1;
...
801059e3:	68 60 63 11 80       	push   $0x80116360
801059e8:	e8 23 ed ff ff       	call   80104710 <release>
  return 0;
...
801059fc:	eb f4                	jmp    801059f2 <sys_sleep+0xb2>
...
80105a0c:	83 80 b0 00 00 00 01 	addl   $0x1,0xb0(%eax)
  uint xticks;

  acquire(&tickslock);
80105a13:	83 ec 0c             	sub    $0xc,%esp
80105a16:	68 60 63 11 80       	push   $0x80116360
80105a1b:	e8 30 ec ff ff       	call   80104650 <acquire>
  xticks = ticks;
80105a20:	8b 1d a0 6b 11 80    	mov    0x80116ba0,%ebx
  release(&tickslock);
80105a26:	c7 04 24 60 63 11 80 	movl   $0x80116360,(%esp)
80105a2d:	e8 de ec ff ff       	call   80104710 <release>
  return xticks;
}
...
80105a44:	83 ec 14             	sub    $0x14,%esp
  int n;
  myproc()->call_nums[21] ++;
80105a47:	e8 94 dd ff ff       	call   801037e0 <myproc>
80105a4c:	83 80 d0 00 00 00 01 	addl   $0x1,0xd0(%eax)
  if(argint(0, &n) == 0){
80105a53:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105a56:	83 ec 08             	sub    $0x8,%esp
80105a59:	50                   	push   %eax
80105a5a:	6a 00                	push   $0x0
80105a5c:	e8 ff ef ff ff       	call   80104a60 <argint>
80105a61:	83 c4 10             	add    $0x10,%esp
80105a64:	85 c0                	test   %eax,%eax
80105a66:	75 50                	jne    80105ab8 <sys_trace_syscalls+0x78>
80105a68:	89 c3                	mov    %eax,%ebx
    if(myproc()->pid == 3){
80105a6a:	e8 71 dd ff ff       	call   801037e0 <myproc>
80105a6f:	83 78 10 03          	cmpl   $0x3,0x10(%eax)
80105a73:	74 2b                	je     80105aa0 <sys_trace_syscalls+0x60>
      trace_syscalls(2);
      return 0;
    }
    else if (n==1 || n== 0) {
80105a75:	83 7d f4 01          	cmpl   $0x1,-0xc(%ebp)
80105a79:	77 3d                	ja     80105ab8 <sys_trace_syscalls+0x78>
      myproc()-> print_state = n;
80105a7b:	e8 60 dd ff ff       	call   801037e0 <myproc>
80105a80:	8b 55 f4             	mov    -0xc(%ebp),%edx
      trace_syscalls(n);
80105a83:	83 ec 0c             	sub    $0xc,%esp
      myproc()-> print_state = n;
80105a86:	89 90 d4 00 00 00    	mov    %edx,0xd4(%eax)
      trace_syscalls(n);
80105a8c:	52                   	push   %edx
80105a8d:	e8 8e e8 ff ff       	call   80104320 <trace_syscalls>
      return 0;
...
80105a97:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105a9a:	c9                   	leave  
80105a9b:	c3                   	ret    
80105a9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      trace_syscalls(2);
80105aa0:	83 ec 0c             	sub    $0xc,%esp
80105aa3:	6a 02                	push   $0x2
80105aa5:	e8 76 e8 ff ff       	call   80104320 <trace_syscalls>
}
80105aaa:	89 d8                	mov    %ebx,%eax
      return 0;
80105aac:	83 c4 10             	add    $0x10,%esp
}
80105aaf:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105ab2:	c9                   	leave  
80105ab3:	c3                   	ret    
80105ab4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80105ab8:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105abd:	eb d6                	jmp    80105a95 <sys_trace_syscalls+0x55>
...
80105b07:	c7 04 c5 a2 63 11 80 	movl   $0x8e000008,-0x7fee9c5e(,%eax,8)
80105b0e:	08 00 00 8e 
80105b12:	66 89 14 c5 a0 63 11 	mov    %dx,-0x7fee9c60(,%eax,8)
80105b19:	80 
80105b1a:	c1 ea 10             	shr    $0x10,%edx
80105b1d:	66 89 14 c5 a6 63 11 	mov    %dx,-0x7fee9c5a(,%eax,8)
80105b24:	80 
  for(i = 0; i < 256; i++)
...
80105b34:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b37:	c7 05 a2 65 11 80 08 	movl   $0xef000008,0x801165a2
80105b3e:	00 00 ef 
  initlock(&tickslock, "time");
80105b41:	68 b4 79 10 80       	push   $0x801079b4
80105b46:	68 60 63 11 80       	push   $0x80116360
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b4b:	66 a3 a0 65 11 80    	mov    %ax,0x801165a0
80105b51:	c1 e8 10             	shr    $0x10,%eax
80105b54:	66 a3 a6 65 11 80    	mov    %ax,0x801165a6
  initlock(&tickslock, "time");
80105b5a:	e8 b1 e9 ff ff       	call   80104510 <initlock>
}
...
80105b7b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b7f:	b8 a0 63 11 80       	mov    $0x801163a0,%eax
...
80105bc0:	ff 24 85 80 7c 10 80 	jmp    *-0x7fef8380(,%eax,4)
...
80105c25:	68 3c 7c 10 80       	push   $0x80107c3c
...
80105cbd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105cc0:	e8 8b ee ff ff       	call   80104b50 <syscall>
    if(myproc()->killed)
...
80105d67:	68 e4 7b 10 80       	push   $0x80107be4
...
80105dc3:	68 60 63 11 80       	push   $0x80116360
80105dc8:	e8 83 e8 ff ff       	call   80104650 <acquire>
      wakeup(&ticks);
80105dcd:	c7 04 24 a0 6b 11 80 	movl   $0x80116ba0,(%esp)
      ticks++;
80105dd4:	83 05 a0 6b 11 80 01 	addl   $0x1,0x80116ba0
      wakeup(&ticks);
80105ddb:	e8 60 e1 ff ff       	call   80103f40 <wakeup>
      release(&tickslock);
80105de0:	c7 04 24 60 63 11 80 	movl   $0x80116360,(%esp)
80105de7:	e8 24 e9 ff ff       	call   80104710 <release>
...
80105e05:	68 08 7c 10 80       	push   $0x80107c08
80105e0a:	e8 51 a8 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105e0f:	83 c4 14             	add    $0x14,%esp
80105e12:	68 dd 7b 10 80       	push   $0x80107bdd
...
80105f0c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105f0f:	bb 00 7d 10 80       	mov    $0x80107d00,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105fa7:	6a 00                	push   $0x0
  jmp alltraps
80105fa9:	e9 11 fb ff ff       	jmp    80105abf <alltraps>
...
80105fb0:	6a 01                	push   $0x1
  jmp alltraps
80105fb2:	e9 08 fb ff ff       	jmp    80105abf <alltraps>
...
80105fb9:	6a 02                	push   $0x2
  jmp alltraps
80105fbb:	e9 ff fa ff ff       	jmp    80105abf <alltraps>
...
80105fc2:	6a 03                	push   $0x3
  jmp alltraps
80105fc4:	e9 f6 fa ff ff       	jmp    80105abf <alltraps>
...
80105fcb:	6a 04                	push   $0x4
  jmp alltraps
80105fcd:	e9 ed fa ff ff       	jmp    80105abf <alltraps>
...
80105fd4:	6a 05                	push   $0x5
  jmp alltraps
80105fd6:	e9 e4 fa ff ff       	jmp    80105abf <alltraps>
...
80105fdd:	6a 06                	push   $0x6
  jmp alltraps
80105fdf:	e9 db fa ff ff       	jmp    80105abf <alltraps>
...
80105fe6:	6a 07                	push   $0x7
  jmp alltraps
80105fe8:	e9 d2 fa ff ff       	jmp    80105abf <alltraps>
...
80106004:	6a 0b                	push   $0xb
  jmp alltraps
80106006:	e9 b4 fa ff ff       	jmp    80105abf <alltraps>
...
8010600b:	6a 0c                	push   $0xc
  jmp alltraps
8010600d:	e9 ad fa ff ff       	jmp    80105abf <alltraps>
...
80106012:	6a 0d                	push   $0xd
  jmp alltraps
80106014:	e9 a6 fa ff ff       	jmp    80105abf <alltraps>
...
80106019:	6a 0e                	push   $0xe
  jmp alltraps
8010601b:	e9 9f fa ff ff       	jmp    80105abf <alltraps>
...
8010602b:	6a 10                	push   $0x10
  jmp alltraps
8010602d:	e9 8d fa ff ff       	jmp    80105abf <alltraps>
...
80106044:	6a 13                	push   $0x13
  jmp alltraps
80106046:	e9 74 fa ff ff       	jmp    80105abf <alltraps>
...
8010604d:	6a 14                	push   $0x14
  jmp alltraps
8010604f:	e9 6b fa ff ff       	jmp    80105abf <alltraps>
...
80106056:	6a 15                	push   $0x15
  jmp alltraps
80106058:	e9 62 fa ff ff       	jmp    80105abf <alltraps>
...
8010605f:	6a 16                	push   $0x16
  jmp alltraps
80106061:	e9 59 fa ff ff       	jmp    80105abf <alltraps>
...
80106068:	6a 17                	push   $0x17
  jmp alltraps
8010606a:	e9 50 fa ff ff       	jmp    80105abf <alltraps>
...
80106071:	6a 18                	push   $0x18
  jmp alltraps
80106073:	e9 47 fa ff ff       	jmp    80105abf <alltraps>
...
8010607a:	6a 19                	push   $0x19
  jmp alltraps
8010607c:	e9 3e fa ff ff       	jmp    80105abf <alltraps>
...
80106083:	6a 1a                	push   $0x1a
  jmp alltraps
80106085:	e9 35 fa ff ff       	jmp    80105abf <alltraps>
...
8010608c:	6a 1b                	push   $0x1b
  jmp alltraps
8010608e:	e9 2c fa ff ff       	jmp    80105abf <alltraps>
...
80106095:	6a 1c                	push   $0x1c
  jmp alltraps
80106097:	e9 23 fa ff ff       	jmp    80105abf <alltraps>
...
8010609e:	6a 1d                	push   $0x1d
  jmp alltraps
801060a0:	e9 1a fa ff ff       	jmp    80105abf <alltraps>
...
801060a7:	6a 1e                	push   $0x1e
  jmp alltraps
801060a9:	e9 11 fa ff ff       	jmp    80105abf <alltraps>
...
801060b0:	6a 1f                	push   $0x1f
  jmp alltraps
801060b2:	e9 08 fa ff ff       	jmp    80105abf <alltraps>
...
801060b9:	6a 20                	push   $0x20
  jmp alltraps
801060bb:	e9 ff f9 ff ff       	jmp    80105abf <alltraps>
...
801060c2:	6a 21                	push   $0x21
  jmp alltraps
801060c4:	e9 f6 f9 ff ff       	jmp    80105abf <alltraps>
...
801060cb:	6a 22                	push   $0x22
  jmp alltraps
801060cd:	e9 ed f9 ff ff       	jmp    80105abf <alltraps>
...
801060d4:	6a 23                	push   $0x23
  jmp alltraps
801060d6:	e9 e4 f9 ff ff       	jmp    80105abf <alltraps>
...
801060dd:	6a 24                	push   $0x24
  jmp alltraps
801060df:	e9 db f9 ff ff       	jmp    80105abf <alltraps>
...
801060e6:	6a 25                	push   $0x25
  jmp alltraps
801060e8:	e9 d2 f9 ff ff       	jmp    80105abf <alltraps>
...
801060ef:	6a 26                	push   $0x26
  jmp alltraps
801060f1:	e9 c9 f9 ff ff       	jmp    80105abf <alltraps>
...
801060f8:	6a 27                	push   $0x27
  jmp alltraps
801060fa:	e9 c0 f9 ff ff       	jmp    80105abf <alltraps>
...
80106101:	6a 28                	push   $0x28
  jmp alltraps
80106103:	e9 b7 f9 ff ff       	jmp    80105abf <alltraps>
...
8010610a:	6a 29                	push   $0x29
  jmp alltraps
8010610c:	e9 ae f9 ff ff       	jmp    80105abf <alltraps>
...
80106113:	6a 2a                	push   $0x2a
  jmp alltraps
80106115:	e9 a5 f9 ff ff       	jmp    80105abf <alltraps>
...
8010611c:	6a 2b                	push   $0x2b
  jmp alltraps
8010611e:	e9 9c f9 ff ff       	jmp    80105abf <alltraps>
...
80106125:	6a 2c                	push   $0x2c
  jmp alltraps
80106127:	e9 93 f9 ff ff       	jmp    80105abf <alltraps>
...
8010612e:	6a 2d                	push   $0x2d
  jmp alltraps
80106130:	e9 8a f9 ff ff       	jmp    80105abf <alltraps>
...
80106137:	6a 2e                	push   $0x2e
  jmp alltraps
80106139:	e9 81 f9 ff ff       	jmp    80105abf <alltraps>
...
80106140:	6a 2f                	push   $0x2f
  jmp alltraps
80106142:	e9 78 f9 ff ff       	jmp    80105abf <alltraps>
...
80106149:	6a 30                	push   $0x30
  jmp alltraps
8010614b:	e9 6f f9 ff ff       	jmp    80105abf <alltraps>
...
80106152:	6a 31                	push   $0x31
  jmp alltraps
80106154:	e9 66 f9 ff ff       	jmp    80105abf <alltraps>
...
8010615b:	6a 32                	push   $0x32
  jmp alltraps
8010615d:	e9 5d f9 ff ff       	jmp    80105abf <alltraps>
...
80106164:	6a 33                	push   $0x33
  jmp alltraps
80106166:	e9 54 f9 ff ff       	jmp    80105abf <alltraps>
...
8010616d:	6a 34                	push   $0x34
  jmp alltraps
8010616f:	e9 4b f9 ff ff       	jmp    80105abf <alltraps>
...
80106176:	6a 35                	push   $0x35
  jmp alltraps
80106178:	e9 42 f9 ff ff       	jmp    80105abf <alltraps>
...
8010617f:	6a 36                	push   $0x36
  jmp alltraps
80106181:	e9 39 f9 ff ff       	jmp    80105abf <alltraps>
...
80106188:	6a 37                	push   $0x37
  jmp alltraps
8010618a:	e9 30 f9 ff ff       	jmp    80105abf <alltraps>
...
80106191:	6a 38                	push   $0x38
  jmp alltraps
80106193:	e9 27 f9 ff ff       	jmp    80105abf <alltraps>
...
8010619a:	6a 39                	push   $0x39
  jmp alltraps
8010619c:	e9 1e f9 ff ff       	jmp    80105abf <alltraps>
...
801061a3:	6a 3a                	push   $0x3a
  jmp alltraps
801061a5:	e9 15 f9 ff ff       	jmp    80105abf <alltraps>
...
801061ac:	6a 3b                	push   $0x3b
  jmp alltraps
801061ae:	e9 0c f9 ff ff       	jmp    80105abf <alltraps>
...
801061b5:	6a 3c                	push   $0x3c
  jmp alltraps
801061b7:	e9 03 f9 ff ff       	jmp    80105abf <alltraps>
...
801061be:	6a 3d                	push   $0x3d
  jmp alltraps
801061c0:	e9 fa f8 ff ff       	jmp    80105abf <alltraps>
...
801061c7:	6a 3e                	push   $0x3e
  jmp alltraps
801061c9:	e9 f1 f8 ff ff       	jmp    80105abf <alltraps>
...
801061d0:	6a 3f                	push   $0x3f
  jmp alltraps
801061d2:	e9 e8 f8 ff ff       	jmp    80105abf <alltraps>
...
801061d9:	6a 40                	push   $0x40
  jmp alltraps
801061db:	e9 df f8 ff ff       	jmp    80105abf <alltraps>
...
801061e2:	6a 41                	push   $0x41
  jmp alltraps
801061e4:	e9 d6 f8 ff ff       	jmp    80105abf <alltraps>
...
801061eb:	6a 42                	push   $0x42
  jmp alltraps
801061ed:	e9 cd f8 ff ff       	jmp    80105abf <alltraps>
...
801061f4:	6a 43                	push   $0x43
  jmp alltraps
801061f6:	e9 c4 f8 ff ff       	jmp    80105abf <alltraps>
...
801061fd:	6a 44                	push   $0x44
  jmp alltraps
801061ff:	e9 bb f8 ff ff       	jmp    80105abf <alltraps>
...
80106206:	6a 45                	push   $0x45
  jmp alltraps
80106208:	e9 b2 f8 ff ff       	jmp    80105abf <alltraps>
...
8010620f:	6a 46                	push   $0x46
  jmp alltraps
80106211:	e9 a9 f8 ff ff       	jmp    80105abf <alltraps>
...
80106218:	6a 47                	push   $0x47
  jmp alltraps
8010621a:	e9 a0 f8 ff ff       	jmp    80105abf <alltraps>
...
80106221:	6a 48                	push   $0x48
  jmp alltraps
80106223:	e9 97 f8 ff ff       	jmp    80105abf <alltraps>
...
8010622a:	6a 49                	push   $0x49
  jmp alltraps
8010622c:	e9 8e f8 ff ff       	jmp    80105abf <alltraps>
...
80106233:	6a 4a                	push   $0x4a
  jmp alltraps
80106235:	e9 85 f8 ff ff       	jmp    80105abf <alltraps>
...
8010623c:	6a 4b                	push   $0x4b
  jmp alltraps
8010623e:	e9 7c f8 ff ff       	jmp    80105abf <alltraps>
...
80106245:	6a 4c                	push   $0x4c
  jmp alltraps
80106247:	e9 73 f8 ff ff       	jmp    80105abf <alltraps>
...
8010624e:	6a 4d                	push   $0x4d
  jmp alltraps
80106250:	e9 6a f8 ff ff       	jmp    80105abf <alltraps>
...
80106257:	6a 4e                	push   $0x4e
  jmp alltraps
80106259:	e9 61 f8 ff ff       	jmp    80105abf <alltraps>
...
80106260:	6a 4f                	push   $0x4f
  jmp alltraps
80106262:	e9 58 f8 ff ff       	jmp    80105abf <alltraps>
...
80106269:	6a 50                	push   $0x50
  jmp alltraps
8010626b:	e9 4f f8 ff ff       	jmp    80105abf <alltraps>
...
80106272:	6a 51                	push   $0x51
  jmp alltraps
80106274:	e9 46 f8 ff ff       	jmp    80105abf <alltraps>
...
8010627b:	6a 52                	push   $0x52
  jmp alltraps
8010627d:	e9 3d f8 ff ff       	jmp    80105abf <alltraps>
...
80106284:	6a 53                	push   $0x53
  jmp alltraps
80106286:	e9 34 f8 ff ff       	jmp    80105abf <alltraps>
...
8010628d:	6a 54                	push   $0x54
  jmp alltraps
8010628f:	e9 2b f8 ff ff       	jmp    80105abf <alltraps>
...
80106296:	6a 55                	push   $0x55
  jmp alltraps
80106298:	e9 22 f8 ff ff       	jmp    80105abf <alltraps>
...
8010629f:	6a 56                	push   $0x56
  jmp alltraps
801062a1:	e9 19 f8 ff ff       	jmp    80105abf <alltraps>
...
801062a8:	6a 57                	push   $0x57
  jmp alltraps
801062aa:	e9 10 f8 ff ff       	jmp    80105abf <alltraps>
...
801062b1:	6a 58                	push   $0x58
  jmp alltraps
801062b3:	e9 07 f8 ff ff       	jmp    80105abf <alltraps>
...
801062ba:	6a 59                	push   $0x59
  jmp alltraps
801062bc:	e9 fe f7 ff ff       	jmp    80105abf <alltraps>
...
801062c3:	6a 5a                	push   $0x5a
  jmp alltraps
801062c5:	e9 f5 f7 ff ff       	jmp    80105abf <alltraps>
...
801062cc:	6a 5b                	push   $0x5b
  jmp alltraps
801062ce:	e9 ec f7 ff ff       	jmp    80105abf <alltraps>
...
801062d5:	6a 5c                	push   $0x5c
  jmp alltraps
801062d7:	e9 e3 f7 ff ff       	jmp    80105abf <alltraps>
...
801062de:	6a 5d                	push   $0x5d
  jmp alltraps
801062e0:	e9 da f7 ff ff       	jmp    80105abf <alltraps>
...
801062e7:	6a 5e                	push   $0x5e
  jmp alltraps
801062e9:	e9 d1 f7 ff ff       	jmp    80105abf <alltraps>
...
801062f0:	6a 5f                	push   $0x5f
  jmp alltraps
801062f2:	e9 c8 f7 ff ff       	jmp    80105abf <alltraps>
...
801062f9:	6a 60                	push   $0x60
  jmp alltraps
801062fb:	e9 bf f7 ff ff       	jmp    80105abf <alltraps>
...
80106302:	6a 61                	push   $0x61
  jmp alltraps
80106304:	e9 b6 f7 ff ff       	jmp    80105abf <alltraps>
...
8010630b:	6a 62                	push   $0x62
  jmp alltraps
8010630d:	e9 ad f7 ff ff       	jmp    80105abf <alltraps>
...
80106314:	6a 63                	push   $0x63
  jmp alltraps
80106316:	e9 a4 f7 ff ff       	jmp    80105abf <alltraps>
...
8010631d:	6a 64                	push   $0x64
  jmp alltraps
8010631f:	e9 9b f7 ff ff       	jmp    80105abf <alltraps>
...
80106326:	6a 65                	push   $0x65
  jmp alltraps
80106328:	e9 92 f7 ff ff       	jmp    80105abf <alltraps>
...
8010632f:	6a 66                	push   $0x66
  jmp alltraps
80106331:	e9 89 f7 ff ff       	jmp    80105abf <alltraps>
...
80106338:	6a 67                	push   $0x67
  jmp alltraps
8010633a:	e9 80 f7 ff ff       	jmp    80105abf <alltraps>
...
80106341:	6a 68                	push   $0x68
  jmp alltraps
80106343:	e9 77 f7 ff ff       	jmp    80105abf <alltraps>
...
8010634a:	6a 69                	push   $0x69
  jmp alltraps
8010634c:	e9 6e f7 ff ff       	jmp    80105abf <alltraps>
...
80106353:	6a 6a                	push   $0x6a
  jmp alltraps
80106355:	e9 65 f7 ff ff       	jmp    80105abf <alltraps>
...
8010635c:	6a 6b                	push   $0x6b
  jmp alltraps
8010635e:	e9 5c f7 ff ff       	jmp    80105abf <alltraps>
...
80106365:	6a 6c                	push   $0x6c
  jmp alltraps
80106367:	e9 53 f7 ff ff       	jmp    80105abf <alltraps>
...
8010636e:	6a 6d                	push   $0x6d
  jmp alltraps
80106370:	e9 4a f7 ff ff       	jmp    80105abf <alltraps>
...
80106377:	6a 6e                	push   $0x6e
  jmp alltraps
80106379:	e9 41 f7 ff ff       	jmp    80105abf <alltraps>
...
80106380:	6a 6f                	push   $0x6f
  jmp alltraps
80106382:	e9 38 f7 ff ff       	jmp    80105abf <alltraps>
...
80106389:	6a 70                	push   $0x70
  jmp alltraps
8010638b:	e9 2f f7 ff ff       	jmp    80105abf <alltraps>
...
80106392:	6a 71                	push   $0x71
  jmp alltraps
80106394:	e9 26 f7 ff ff       	jmp    80105abf <alltraps>
...
8010639b:	6a 72                	push   $0x72
  jmp alltraps
8010639d:	e9 1d f7 ff ff       	jmp    80105abf <alltraps>
...
801063a4:	6a 73                	push   $0x73
  jmp alltraps
801063a6:	e9 14 f7 ff ff       	jmp    80105abf <alltraps>
...
801063ad:	6a 74                	push   $0x74
  jmp alltraps
801063af:	e9 0b f7 ff ff       	jmp    80105abf <alltraps>
...
801063b6:	6a 75                	push   $0x75
  jmp alltraps
801063b8:	e9 02 f7 ff ff       	jmp    80105abf <alltraps>
...
801063bf:	6a 76                	push   $0x76
  jmp alltraps
801063c1:	e9 f9 f6 ff ff       	jmp    80105abf <alltraps>
...
801063c8:	6a 77                	push   $0x77
  jmp alltraps
801063ca:	e9 f0 f6 ff ff       	jmp    80105abf <alltraps>
...
801063d1:	6a 78                	push   $0x78
  jmp alltraps
801063d3:	e9 e7 f6 ff ff       	jmp    80105abf <alltraps>
...
801063da:	6a 79                	push   $0x79
  jmp alltraps
801063dc:	e9 de f6 ff ff       	jmp    80105abf <alltraps>
...
801063e3:	6a 7a                	push   $0x7a
  jmp alltraps
801063e5:	e9 d5 f6 ff ff       	jmp    80105abf <alltraps>
...
801063ec:	6a 7b                	push   $0x7b
  jmp alltraps
801063ee:	e9 cc f6 ff ff       	jmp    80105abf <alltraps>
...
801063f5:	6a 7c                	push   $0x7c
  jmp alltraps
801063f7:	e9 c3 f6 ff ff       	jmp    80105abf <alltraps>
...
801063fe:	6a 7d                	push   $0x7d
  jmp alltraps
80106400:	e9 ba f6 ff ff       	jmp    80105abf <alltraps>
...
80106407:	6a 7e                	push   $0x7e
  jmp alltraps
80106409:	e9 b1 f6 ff ff       	jmp    80105abf <alltraps>
...
80106410:	6a 7f                	push   $0x7f
  jmp alltraps
80106412:	e9 a8 f6 ff ff       	jmp    80105abf <alltraps>
...
80106419:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010641e:	e9 9c f6 ff ff       	jmp    80105abf <alltraps>
...
80106425:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010642a:	e9 90 f6 ff ff       	jmp    80105abf <alltraps>
...
80106431:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106436:	e9 84 f6 ff ff       	jmp    80105abf <alltraps>
...
8010643d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106442:	e9 78 f6 ff ff       	jmp    80105abf <alltraps>
...
80106449:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010644e:	e9 6c f6 ff ff       	jmp    80105abf <alltraps>
...
80106455:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010645a:	e9 60 f6 ff ff       	jmp    80105abf <alltraps>
...
80106461:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106466:	e9 54 f6 ff ff       	jmp    80105abf <alltraps>
...
8010646d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106472:	e9 48 f6 ff ff       	jmp    80105abf <alltraps>
...
80106479:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010647e:	e9 3c f6 ff ff       	jmp    80105abf <alltraps>
...
80106485:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010648a:	e9 30 f6 ff ff       	jmp    80105abf <alltraps>
...
80106491:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106496:	e9 24 f6 ff ff       	jmp    80105abf <alltraps>
...
8010649d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801064a2:	e9 18 f6 ff ff       	jmp    80105abf <alltraps>
...
801064a9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801064ae:	e9 0c f6 ff ff       	jmp    80105abf <alltraps>
...
801064b5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801064ba:	e9 00 f6 ff ff       	jmp    80105abf <alltraps>
...
801064c1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801064c6:	e9 f4 f5 ff ff       	jmp    80105abf <alltraps>
...
801064cd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801064d2:	e9 e8 f5 ff ff       	jmp    80105abf <alltraps>
...
801064d9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801064de:	e9 dc f5 ff ff       	jmp    80105abf <alltraps>
...
801064e5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801064ea:	e9 d0 f5 ff ff       	jmp    80105abf <alltraps>
...
801064f1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801064f6:	e9 c4 f5 ff ff       	jmp    80105abf <alltraps>
...
801064fd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106502:	e9 b8 f5 ff ff       	jmp    80105abf <alltraps>
...
80106509:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010650e:	e9 ac f5 ff ff       	jmp    80105abf <alltraps>
...
80106515:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010651a:	e9 a0 f5 ff ff       	jmp    80105abf <alltraps>
...
80106521:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106526:	e9 94 f5 ff ff       	jmp    80105abf <alltraps>
...
8010652d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106532:	e9 88 f5 ff ff       	jmp    80105abf <alltraps>
...
80106539:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010653e:	e9 7c f5 ff ff       	jmp    80105abf <alltraps>
...
80106545:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010654a:	e9 70 f5 ff ff       	jmp    80105abf <alltraps>
...
80106551:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106556:	e9 64 f5 ff ff       	jmp    80105abf <alltraps>
...
8010655d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106562:	e9 58 f5 ff ff       	jmp    80105abf <alltraps>
...
80106569:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010656e:	e9 4c f5 ff ff       	jmp    80105abf <alltraps>
...
80106575:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010657a:	e9 40 f5 ff ff       	jmp    80105abf <alltraps>
...
80106581:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106586:	e9 34 f5 ff ff       	jmp    80105abf <alltraps>
...
8010658d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106592:	e9 28 f5 ff ff       	jmp    80105abf <alltraps>
...
80106599:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010659e:	e9 1c f5 ff ff       	jmp    80105abf <alltraps>
...
801065a5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801065aa:	e9 10 f5 ff ff       	jmp    80105abf <alltraps>
...
801065b1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801065b6:	e9 04 f5 ff ff       	jmp    80105abf <alltraps>
...
801065bd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801065c2:	e9 f8 f4 ff ff       	jmp    80105abf <alltraps>
...
801065c9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801065ce:	e9 ec f4 ff ff       	jmp    80105abf <alltraps>
...
801065d5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801065da:	e9 e0 f4 ff ff       	jmp    80105abf <alltraps>
...
801065e1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801065e6:	e9 d4 f4 ff ff       	jmp    80105abf <alltraps>
...
801065ed:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801065f2:	e9 c8 f4 ff ff       	jmp    80105abf <alltraps>
...
801065f9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801065fe:	e9 bc f4 ff ff       	jmp    80105abf <alltraps>
...
80106605:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010660a:	e9 b0 f4 ff ff       	jmp    80105abf <alltraps>
...
80106611:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106616:	e9 a4 f4 ff ff       	jmp    80105abf <alltraps>
...
8010661d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106622:	e9 98 f4 ff ff       	jmp    80105abf <alltraps>
...
80106629:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010662e:	e9 8c f4 ff ff       	jmp    80105abf <alltraps>
...
80106635:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010663a:	e9 80 f4 ff ff       	jmp    80105abf <alltraps>
...
80106641:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106646:	e9 74 f4 ff ff       	jmp    80105abf <alltraps>
...
8010664d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106652:	e9 68 f4 ff ff       	jmp    80105abf <alltraps>
...
80106659:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010665e:	e9 5c f4 ff ff       	jmp    80105abf <alltraps>
...
80106665:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010666a:	e9 50 f4 ff ff       	jmp    80105abf <alltraps>
...
80106671:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106676:	e9 44 f4 ff ff       	jmp    80105abf <alltraps>
...
8010667d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106682:	e9 38 f4 ff ff       	jmp    80105abf <alltraps>
...
80106689:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010668e:	e9 2c f4 ff ff       	jmp    80105abf <alltraps>
...
80106695:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010669a:	e9 20 f4 ff ff       	jmp    80105abf <alltraps>
...
801066a1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801066a6:	e9 14 f4 ff ff       	jmp    80105abf <alltraps>
...
801066ad:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801066b2:	e9 08 f4 ff ff       	jmp    80105abf <alltraps>
...
801066b9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801066be:	e9 fc f3 ff ff       	jmp    80105abf <alltraps>
...
801066c5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801066ca:	e9 f0 f3 ff ff       	jmp    80105abf <alltraps>
...
801066d1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801066d6:	e9 e4 f3 ff ff       	jmp    80105abf <alltraps>
...
801066dd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801066e2:	e9 d8 f3 ff ff       	jmp    80105abf <alltraps>
...
801066e9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801066ee:	e9 cc f3 ff ff       	jmp    80105abf <alltraps>
...
801066f5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801066fa:	e9 c0 f3 ff ff       	jmp    80105abf <alltraps>
...
80106701:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106706:	e9 b4 f3 ff ff       	jmp    80105abf <alltraps>
...
8010670d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106712:	e9 a8 f3 ff ff       	jmp    80105abf <alltraps>
...
80106719:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010671e:	e9 9c f3 ff ff       	jmp    80105abf <alltraps>
...
80106725:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010672a:	e9 90 f3 ff ff       	jmp    80105abf <alltraps>
...
80106731:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106736:	e9 84 f3 ff ff       	jmp    80105abf <alltraps>
...
8010673d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106742:	e9 78 f3 ff ff       	jmp    80105abf <alltraps>
...
80106749:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010674e:	e9 6c f3 ff ff       	jmp    80105abf <alltraps>
...
80106755:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010675a:	e9 60 f3 ff ff       	jmp    80105abf <alltraps>
...
80106761:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106766:	e9 54 f3 ff ff       	jmp    80105abf <alltraps>
...
8010676d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106772:	e9 48 f3 ff ff       	jmp    80105abf <alltraps>
...
80106779:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010677e:	e9 3c f3 ff ff       	jmp    80105abf <alltraps>
...
80106785:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010678a:	e9 30 f3 ff ff       	jmp    80105abf <alltraps>
...
80106791:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106796:	e9 24 f3 ff ff       	jmp    80105abf <alltraps>
...
8010679d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801067a2:	e9 18 f3 ff ff       	jmp    80105abf <alltraps>
...
801067a9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801067ae:	e9 0c f3 ff ff       	jmp    80105abf <alltraps>
...
801067b5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801067ba:	e9 00 f3 ff ff       	jmp    80105abf <alltraps>
...
801067c1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801067c6:	e9 f4 f2 ff ff       	jmp    80105abf <alltraps>
...
801067cd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801067d2:	e9 e8 f2 ff ff       	jmp    80105abf <alltraps>
...
801067d9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801067de:	e9 dc f2 ff ff       	jmp    80105abf <alltraps>
...
801067e5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801067ea:	e9 d0 f2 ff ff       	jmp    80105abf <alltraps>
...
801067f1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801067f6:	e9 c4 f2 ff ff       	jmp    80105abf <alltraps>
...
801067fd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106802:	e9 b8 f2 ff ff       	jmp    80105abf <alltraps>
...
80106809:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010680e:	e9 ac f2 ff ff       	jmp    80105abf <alltraps>
...
80106815:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010681a:	e9 a0 f2 ff ff       	jmp    80105abf <alltraps>
...
80106821:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106826:	e9 94 f2 ff ff       	jmp    80105abf <alltraps>
...
8010682d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106832:	e9 88 f2 ff ff       	jmp    80105abf <alltraps>
...
80106839:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010683e:	e9 7c f2 ff ff       	jmp    80105abf <alltraps>
...
80106845:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010684a:	e9 70 f2 ff ff       	jmp    80105abf <alltraps>
...
80106851:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106856:	e9 64 f2 ff ff       	jmp    80105abf <alltraps>
...
8010685d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106862:	e9 58 f2 ff ff       	jmp    80105abf <alltraps>
...
80106869:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010686e:	e9 4c f2 ff ff       	jmp    80105abf <alltraps>
...
80106875:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010687a:	e9 40 f2 ff ff       	jmp    80105abf <alltraps>
...
80106881:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106886:	e9 34 f2 ff ff       	jmp    80105abf <alltraps>
...
8010688d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106892:	e9 28 f2 ff ff       	jmp    80105abf <alltraps>
...
80106899:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010689e:	e9 1c f2 ff ff       	jmp    80105abf <alltraps>
...
801068a5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801068aa:	e9 10 f2 ff ff       	jmp    80105abf <alltraps>
...
801068b1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801068b6:	e9 04 f2 ff ff       	jmp    80105abf <alltraps>
...
801068bd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801068c2:	e9 f8 f1 ff ff       	jmp    80105abf <alltraps>
...
801068c9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801068ce:	e9 ec f1 ff ff       	jmp    80105abf <alltraps>
...
801068d5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801068da:	e9 e0 f1 ff ff       	jmp    80105abf <alltraps>
...
801068e1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801068e6:	e9 d4 f1 ff ff       	jmp    80105abf <alltraps>
...
801068ed:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801068f2:	e9 c8 f1 ff ff       	jmp    80105abf <alltraps>
...
801068f9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801068fe:	e9 bc f1 ff ff       	jmp    80105abf <alltraps>
...
80106905:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010690a:	e9 b0 f1 ff ff       	jmp    80105abf <alltraps>
...
80106911:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106916:	e9 a4 f1 ff ff       	jmp    80105abf <alltraps>
...
8010691d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106922:	e9 98 f1 ff ff       	jmp    80105abf <alltraps>
...
80106929:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010692e:	e9 8c f1 ff ff       	jmp    80105abf <alltraps>
...
80106935:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010693a:	e9 80 f1 ff ff       	jmp    80105abf <alltraps>
...
80106941:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106946:	e9 74 f1 ff ff       	jmp    80105abf <alltraps>
...
8010694d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106952:	e9 68 f1 ff ff       	jmp    80105abf <alltraps>
...
80106959:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010695e:	e9 5c f1 ff ff       	jmp    80105abf <alltraps>
...
80106965:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010696a:	e9 50 f1 ff ff       	jmp    80105abf <alltraps>
...
80106971:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106976:	e9 44 f1 ff ff       	jmp    80105abf <alltraps>
...
8010697d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106982:	e9 38 f1 ff ff       	jmp    80105abf <alltraps>
...
80106989:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010698e:	e9 2c f1 ff ff       	jmp    80105abf <alltraps>
...
80106995:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010699a:	e9 20 f1 ff ff       	jmp    80105abf <alltraps>
...
801069a1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801069a6:	e9 14 f1 ff ff       	jmp    80105abf <alltraps>
...
801069ad:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801069b2:	e9 08 f1 ff ff       	jmp    80105abf <alltraps>
...
801069b9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801069be:	e9 fc f0 ff ff       	jmp    80105abf <alltraps>
...
801069c5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801069ca:	e9 f0 f0 ff ff       	jmp    80105abf <alltraps>
...
801069d1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801069d6:	e9 e4 f0 ff ff       	jmp    80105abf <alltraps>
...
801069dd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801069e2:	e9 d8 f0 ff ff       	jmp    80105abf <alltraps>
...
801069e9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801069ee:	e9 cc f0 ff ff       	jmp    80105abf <alltraps>
...
801069f5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801069fa:	e9 c0 f0 ff ff       	jmp    80105abf <alltraps>
...
80106a01:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106a06:	e9 b4 f0 ff ff       	jmp    80105abf <alltraps>
...
80106a0d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106a12:	e9 a8 f0 ff ff       	jmp    80105abf <alltraps>
...
80106a7a:	e8 e1 dc ff ff       	call   80104760 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106b1d:	68 08 7d 10 80       	push   $0x80107d08
...
80106c60:	a1 a4 6b 11 80       	mov    0x80116ba4,%eax
{
...
80106ca4:	0f 84 c2 00 00 00    	je     80106d6c <switchuvm+0xec>
  pushcli();
80106caa:	e8 d1 d8 ff ff       	call   80104580 <pushcli>
...
80106dbf:	e8 9c d9 ff ff       	call   80104760 <memset>
...
80106df0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106df1:	e9 1a da ff ff       	jmp    80104810 <memmove>
    panic("inituvm: more than a page");
80106df6:	83 ec 0c             	sub    $0xc,%esp
80106df9:	68 4d 7d 10 80       	push   $0x80107d4d
...
80106f1b:	e8 40 d8 ff ff       	call   80104760 <memset>
...
80106f5d:	68 85 7d 10 80       	push   $0x80107d85
...
80106f93:	68 9d 7d 10 80       	push   $0x80107d9d
...
8010709c:	68 b9 7d 10 80       	push   $0x80107db9
...
801070d0:	e8 8b d6 ff ff       	call   80104760 <memset>
...
8010713b:	a3 a4 6b 11 80       	mov    %eax,0x80116ba4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010716f:	68 ca 7d 10 80       	push   $0x80107dca
...
80107259:	68 ee 7d 10 80       	push   $0x80107dee
8010725e:	e8 2d 91 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107263:	83 ec 0c             	sub    $0xc,%esp
80107266:	68 d4 7d 10 80       	push   $0x80107dd4
...
801072ef:	e8 1c d5 ff ff       	call   80104810 <memmove>
    len -= n;
    buf += n;
